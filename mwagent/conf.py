...
copyright = u'2001-2026, Adiscon GmbH'
...
exclude_patterns = ['index.rsyslog.rst',
  		    ...
  		    'index.syslogviewer.rst',
                    ...
                    'commonuses.rst',
                    'gettinghelp.rst',
                    'articles/index-mwagent.rst',
                    'step-by-step/how-to-enter-the-license-information.rst',
                    'shared/index.rst',
                    'shared/gettingstarted/*.rst',
                    'shared/references/index.rst',
                    'shared/references/connecttocomputer.rst',
                    ...
                    'shared/references/microsoftsystemerrorcodes.rst',
                    'shared/references/mwagentservice2.rst',
                    'shared/references/registrypaths.rst',
                    'introduction/*.rst',
                    'producttour/*.rst',
                    'mwagentspecific/articles.rst',
                    'mwagentspecific/faq/massrollout.rst',
                    'mwagentspecific/faq/massupdaterollout.rst']
...
html_baseurl = os.environ.get('SPHINX_HTML_BASEURL') or 'https://www.mwagent.com/files/manual/current/'
