...
exclude_patterns = ['articles/index-mwagent.rst', 'articles/include-event-id-in-syslog-msg.rst',
   ...
   'mwagentspecific/a-syslogqueueaction.rst','mwagentspecific/cpumonitor.rst',
...
#'gettingstarted/emailnotifications.rst',
   ...
   'glossaryofterms/database.rst',
   'glossaryofterms/repository.rst','glossaryofterms/syslog.rst','faq/index-mwagent.rst',
   'faq/diff-massroll-massupdateroll.rst','faq/massrollout.rst','faq/massupdaterollout.rst',
...
#'gettingstarted/ignoringevents.rst',
   ...
   'rsyslogwaspecific/*.rst','rsyslogwaspecific/faq/*.rst','references/editioncomparison.rst',
   ...
   'mwagentspecific/introduction.rst',
   'mwagentspecific/understand-the-components.rst',
   'mwagentspecific/collect-and-monitor-data.rst',
   'mwagentspecific/creating-an-initial-configuration.rst',
   'mwagentspecific/process-and-filter.rst',
   'mwagentspecific/store-and-forward.rst',
   'mwagentspecific/operate-and-troubleshoot.rst',
   'mwagentspecific/references.rst',
   'mwagentspecific/glossary.rst',
...
html_baseurl = os.environ.get('SPHINX_HTML_BASEURL') or 'https://www.winsyslog.com/files/manual/current/'
...
pdf_documents = [
    (master_doc, u'WinSyslog', u'WinSyslog Configuration Documentation',
     author, 'WinSyslog', 'An enhanced syslog server for windows.',
     'System Tools'),
]
