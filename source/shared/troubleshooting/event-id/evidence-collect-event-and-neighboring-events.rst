...
.. only:: eventreporter
   ...
   **EventReporter:** Event Viewer > Windows Logs > Application > Filter Current Log.

.. only:: winsyslog or winsyslog_j

   **WinSyslog:** Event Viewer > Windows Logs > Application > Filter Current Log.

.. only:: mwagent

   **MonitorWare Agent:** Event Viewer > Windows Logs > Application > Filter Current Log.

.. only:: rsyslog

   **rsyslog Windows Agent:** Event Viewer > Windows Logs > Application > Filter Current Log.
