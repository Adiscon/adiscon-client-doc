...
.. _winsyslog-event-id-901:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 901: Blocked license key rejected.
   :event-id: 901
...
WinSyslog Event ID 901: Blocked license key rejected
====================================================
