...
.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11148: Event Log Monitor could not create its saved bookmark.
   :event-id: 11148
...
WinSyslog Event ID 11148: Event Log Monitor could not create its saved bookmark
===============================================================================
