...
.. _winsyslog-event-id-11157:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11157: Existing archive could not be renamed to prevent overwrite.
   :event-id: 11157
...
WinSyslog Event ID 11157: Existing archive could not be renamed to prevent overwrite
====================================================================================
