...
.. _winsyslog-event-id-11072:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11072: DTLS listener: listener could not bind to its configured address.
   :event-id: 11072
...
WinSyslog Event ID 11072: DTLS listener: listener could not bind to its configured address
==========================================================================================
...
- :ref:`Event ID 11073 <winsyslog-event-id-11073>`
