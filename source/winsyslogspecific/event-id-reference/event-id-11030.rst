...
.. _winsyslog-event-id-11030:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11030: ODBC database action: database operation failed.
   :event-id: 11030
...
WinSyslog Event ID 11030: ODBC database action: database operation failed
=========================================================================
...
- :ref:`Event ID 11010 <winsyslog-event-id-11010>`
