...
.. _winsyslog-event-id-11182:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11182: Queue manager: disk queue cache operation failed.
   :event-id: 11182
...
WinSyslog Event ID 11182: Queue manager: disk queue cache operation failed
==========================================================================
