...
.. _winsyslog-event-id-103:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 103: The service control handler could not be installed.
   :event-id: 103
...
WinSyslog Event ID 103: The service control handler could not be installed
==========================================================================
