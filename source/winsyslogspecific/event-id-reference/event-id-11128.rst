...
.. _winsyslog-event-id-11128:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11128: SMTP listener: SMTP listener raised an exception.
   :event-id: 11128
...
WinSyslog Event ID 11128: SMTP listener: SMTP listener raised an exception
==========================================================================
