...
.. _winsyslog-event-id-11035:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11035: SETP sender: SETP session initialization failed.
   :event-id: 11035
...
WinSyslog Event ID 11035: SETP sender: SETP session initialization failed
=========================================================================
