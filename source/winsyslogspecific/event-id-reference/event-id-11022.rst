...
.. _winsyslog-event-id-11022:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11022: Action processing: action type is missing from configuration.
   :event-id: 11022
...
WinSyslog Event ID 11022: Action processing: action type is missing from configuration
======================================================================================
