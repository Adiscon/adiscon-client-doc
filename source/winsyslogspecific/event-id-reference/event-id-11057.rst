...
.. _winsyslog-event-id-11057:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11057: Network and TLS transport: TLS server initialization failed.
   :event-id: 11057
...
WinSyslog Event ID 11057: Network and TLS transport: TLS server initialization failed
=====================================================================================

Answer
------

Network and TLS transport: TLS server initialization failed. The product recorded this while processing network and tls transport; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`Cwinsock accept ssl connection initialization failed. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11057 does not recur and that network and tls transport processing continues.
...
- :ref:`Event ID 11048 <winsyslog-event-id-11048>`
- :ref:`Event ID 11049 <winsyslog-event-id-11049>`
- :ref:`Event ID 11050 <winsyslog-event-id-11050>`
