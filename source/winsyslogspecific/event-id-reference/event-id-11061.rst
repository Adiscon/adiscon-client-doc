...
.. _winsyslog-event-id-11061:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11061: MonitorWare Echo service: MonitorWare Echo operation raised an exception.
   :event-id: 11061
...
WinSyslog Event ID 11061: MonitorWare Echo service: MonitorWare Echo operation raised an exception
==================================================================================================
