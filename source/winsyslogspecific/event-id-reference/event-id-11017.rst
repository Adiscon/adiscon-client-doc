...
.. _winsyslog-event-id-11017:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11017: Forward Syslog action: action initialization failed.
   :event-id: 11017
...
WinSyslog Event ID 11017: Forward Syslog action: action initialization failed
=============================================================================
