...
.. _winsyslog-event-id-11199:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11199: TCP and TLS listener: TLS server initialization failed.
   :event-id: 11199
...
WinSyslog Event ID 11199: TCP and TLS listener: TLS server initialization failed
================================================================================
