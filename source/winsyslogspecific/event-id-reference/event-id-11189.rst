...
.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11189: Input service could not find its assigned ruleset.
   :event-id: 11189
...
WinSyslog Event ID 11189: Input service could not find its assigned ruleset
===========================================================================
