...
.. _winsyslog-event-id-11141:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11141: Syslog listener: BEEP listener option could not be applied.
   :event-id: 11141
...
WinSyslog Event ID 11141: Syslog listener: BEEP listener option could not be applied
====================================================================================
