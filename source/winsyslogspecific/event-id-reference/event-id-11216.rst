...
.. _winsyslog-event-id-11216:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11216: Control Windows Service action could not open the target service.
   :event-id: 11216
...
WinSyslog Event ID 11216: Control Windows Service action could not open the target service
==========================================================================================
