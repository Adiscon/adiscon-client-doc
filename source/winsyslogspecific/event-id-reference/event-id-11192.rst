...
.. _winsyslog-event-id-11192:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11192: No configured product input service could be started.
   :event-id: 11192
...
WinSyslog Event ID 11192: No configured product input service could be started
==============================================================================
