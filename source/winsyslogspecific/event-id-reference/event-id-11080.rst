...
.. _winsyslog-event-id-11080:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11080: File Monitor service: configured file could not be opened.
   :event-id: 11080
...
WinSyslog Event ID 11080: File Monitor service: configured file could not be opened
===================================================================================
