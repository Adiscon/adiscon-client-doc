...
.. _winsyslog-event-id-11058:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11058: Filter engine: regular expression initialization failed.
   :event-id: 11058
...
WinSyslog Event ID 11058: Filter engine: regular expression initialization failed
=================================================================================
