...
.. _winsyslog-event-id-11032:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11032: OLE DB action: OLE DB operation failed.
   :event-id: 11032
...
WinSyslog Event ID 11032: OLE DB action: OLE DB operation failed
================================================================
