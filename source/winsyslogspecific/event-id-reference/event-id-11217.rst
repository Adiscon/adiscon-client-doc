...
.. _winsyslog-event-id-11217:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11217: Control Windows Service action could not start the target service.
   :event-id: 11217
...
WinSyslog Event ID 11217: Control Windows Service action could not start the target service
===========================================================================================
...
- :ref:`Event ID 11218 <winsyslog-event-id-11218>`
