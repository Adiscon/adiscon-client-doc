...
.. _winsyslog-event-id-11011:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11011: ODBC database action: database operation failed.
   :event-id: 11011
...
WinSyslog Event ID 11011: ODBC database action: database operation failed
=========================================================================
