...
.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11055: TLS client certificate fingerprint could not be computed.
   :event-id: 11055
...
WinSyslog Event ID 11055: TLS client certificate fingerprint could not be computed
==================================================================================
