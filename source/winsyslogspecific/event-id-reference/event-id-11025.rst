...
.. _winsyslog-event-id-11025:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11025: Action processing: invalid action type in configuration.
   :event-id: 11025
...
WinSyslog Event ID 11025: Action processing: invalid action type in configuration
=================================================================================
