...
.. _winsyslog-event-id-11008:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11008: Action configuration: configured action feature is unavailable.
   :event-id: 11008
...
WinSyslog Event ID 11008: Action configuration: configured action feature is unavailable
========================================================================================
...
- **Message pattern:** :spelling:ignore:`Action configuration: configured action feature is unavailable. Additional detail: {event_detail}`
...
- :ref:`Event ID 11007 <winsyslog-event-id-11007>`
