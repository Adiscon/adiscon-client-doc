...
.. _winsyslog-event-id-11147:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11147: Event Log Monitor V2 service: required timer could not be created.
   :event-id: 11147
...
WinSyslog Event ID 11147: Event Log Monitor V2 service: required timer could not be created
===========================================================================================
