...
.. _winsyslog-event-id-11127:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11127: SMTP listener: SMTP listener raised an exception.
   :event-id: 11127
...
WinSyslog Event ID 11127: SMTP listener: SMTP listener raised an exception
==========================================================================
