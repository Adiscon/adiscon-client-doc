...
.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11019: Syslog Queue action has no queue name.
   :event-id: 11019
...
WinSyslog Event ID 11019: Syslog Queue action has no queue name
===============================================================
