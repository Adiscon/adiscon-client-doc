...
.. _winsyslog-event-id-11109:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11109: Event Log Monitor service: Windows Event Log operation failed.
   :event-id: 11109
...
WinSyslog Event ID 11109: Event Log Monitor service: Windows Event Log operation failed
=======================================================================================
