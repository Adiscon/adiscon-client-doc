...
.. _winsyslog-event-id-11051:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11051: Network and TLS transport: TLS operation warning.
   :event-id: 11051
...
WinSyslog Event ID 11051: Network and TLS transport: TLS operation warning
==========================================================================
...
- **Message pattern:** Cwinsock initopensslserversession client ssl certificate verification. Additional detail: {event_detail}
