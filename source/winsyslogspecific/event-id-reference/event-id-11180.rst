...
.. _winsyslog-event-id-11180:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11180: Queue manager: disk queue cache operation failed.
   :event-id: 11180
...
WinSyslog Event ID 11180: Queue manager: disk queue cache operation failed
==========================================================================
