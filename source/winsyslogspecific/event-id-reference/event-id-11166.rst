...
.. _winsyslog-event-id-11166:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11166: OLE DB action: OLE DB operation failed.
   :event-id: 11166
...
WinSyslog Event ID 11166: OLE DB action: OLE DB operation failed
================================================================
