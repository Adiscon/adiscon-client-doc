...
.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11219: Control Windows Service action could not pause the target service.
   :event-id: 11219
...
WinSyslog Event ID 11219: Control Windows Service action could not pause the target service
===========================================================================================
