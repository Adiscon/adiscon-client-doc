...
.. _winsyslog-event-id-11177:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11177: Queue manager: queue capacity condition.
   :event-id: 11177
...
WinSyslog Event ID 11177: Queue manager: queue capacity condition
=================================================================
