...
.. _winsyslog-event-id-11227:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11227: Event rejected after shutdown intake closed.
   :event-id: 11227
...
WinSyslog Event ID 11227: Event rejected after shutdown intake closed
=====================================================================
