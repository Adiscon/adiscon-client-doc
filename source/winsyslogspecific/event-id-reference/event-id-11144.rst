...
.. _winsyslog-event-id-11144:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11144: Syslog listener: listener could not bind to its configured address.
   :event-id: 11144
...
WinSyslog Event ID 11144: Syslog listener: listener could not bind to its configured address
============================================================================================
