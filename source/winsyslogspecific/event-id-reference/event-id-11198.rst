...
.. _winsyslog-event-id-11198:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11198: TCP and TLS listener: TCP listener fatal error.
   :event-id: 11198
...
WinSyslog Event ID 11198: TCP and TLS listener: TCP listener fatal error
========================================================================
