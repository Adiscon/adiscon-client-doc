...
Configuration Client > Services > affected Syslog Listener > Syslog TLS, or Configuration Client > Rulesets > affected rule > Actions > affected Syslog Forwarding action > SSL/TLS related Options.
