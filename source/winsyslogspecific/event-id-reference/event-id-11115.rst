...
.. _winsyslog-event-id-11115:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11115: Syslog listener: listener could not bind to its configured address.
   :event-id: 11115
...
WinSyslog Event ID 11115: Syslog listener: listener could not bind to its configured address
============================================================================================
