...
.. _winsyslog-event-id-11201:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11201: TCP and TLS listener: TCP listener fatal error.
   :event-id: 11201
...
WinSyslog Event ID 11201: TCP and TLS listener: TCP listener fatal error
========================================================================
...
- :ref:`Event ID 11200 <winsyslog-event-id-11200>`
