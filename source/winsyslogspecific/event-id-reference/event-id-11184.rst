...
.. _winsyslog-event-id-11184:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11184: Service configuration: memory reserve could not be allocated.
   :event-id: 11184
...
WinSyslog Event ID 11184: Service configuration: memory reserve could not be allocated
======================================================================================
