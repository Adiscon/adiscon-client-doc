...
.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11037: Send to Communications Port action could not write a byte.
   :event-id: 11037
...
WinSyslog Event ID 11037: Send to Communications Port action could not write a byte
===================================================================================
