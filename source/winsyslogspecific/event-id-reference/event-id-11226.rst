...
.. _winsyslog-event-id-11226:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11226: SNMP listener shutdown wake fallback.
   :event-id: 11226
...
WinSyslog Event ID 11226: SNMP listener shutdown wake fallback
==============================================================
