...
.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11158: Empty log-rotation queue file could not be deleted.
   :event-id: 11158
...
WinSyslog Event ID 11158: Empty log-rotation queue file could not be deleted
============================================================================
