...
.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11071: Disk Space Monitor could not complete a disk-space check.
   :event-id: 11071
...
WinSyslog Event ID 11071: Disk Space Monitor could not complete a disk-space check
==================================================================================
