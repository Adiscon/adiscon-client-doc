...
.. _winsyslog-event-id-11064:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11064: CPU Monitor service: CPU monitor raised an exception.
   :event-id: 11064
...
WinSyslog Event ID 11064: CPU Monitor service: CPU monitor raised an exception
==============================================================================
