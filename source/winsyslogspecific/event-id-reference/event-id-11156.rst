...
.. _winsyslog-event-id-11156:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11156: Rotated log could not be moved to its archive destination.
   :event-id: 11156
...
WinSyslog Event ID 11156: Rotated log could not be moved to its archive destination
===================================================================================
