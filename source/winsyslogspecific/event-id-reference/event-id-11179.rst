...
.. _winsyslog-event-id-11179:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11179: Queue manager: disk queue cache operation failed.
   :event-id: 11179
...
WinSyslog Event ID 11179: Queue manager: disk queue cache operation failed
==========================================================================
