...
.. _winsyslog-event-id-11114:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11114: Syslog listener: listener could not bind to its configured address.
   :event-id: 11114
...
WinSyslog Event ID 11114: Syslog listener: listener could not bind to its configured address
============================================================================================
