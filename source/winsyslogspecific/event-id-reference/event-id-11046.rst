...
.. _winsyslog-event-id-11046:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11046: File-based configuration: file-based configuration could not be loaded.
   :event-id: 11046
...
WinSyslog Event ID 11046: File-based configuration: file-based configuration could not be loaded
================================================================================================
...
- :ref:`Event ID 11045 <winsyslog-event-id-11045>`
