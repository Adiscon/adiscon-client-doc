...
.. _winsyslog-event-id-11191:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11191: Service configuration: log rotation is not licensed.
   :event-id: 11191
...
WinSyslog Event ID 11191: Service configuration: log rotation is not licensed
=============================================================================
