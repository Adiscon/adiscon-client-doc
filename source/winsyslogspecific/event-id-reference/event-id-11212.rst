...
.. _winsyslog-event-id-11212:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11212: System exception while compiling an NT Event Log expression.
   :event-id: 11212
...
WinSyslog Event ID 11212: System exception while compiling an NT Event Log expression
=====================================================================================
...
- **Message pattern:** :spelling:ignore:`System exception while compiling an NT Event Log expression. Additional detail: {event_detail}`
