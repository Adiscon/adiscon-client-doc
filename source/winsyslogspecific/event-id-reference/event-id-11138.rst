...
.. _winsyslog-event-id-11138:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11138: SNMP Trap Receiver: SNMP operation raised an exception.
   :event-id: 11138
...
WinSyslog Event ID 11138: SNMP Trap Receiver: SNMP operation raised an exception
================================================================================
