...
.. _winsyslog-event-id-11181:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11181: Queue manager: disk queue cache operation failed.
   :event-id: 11181
...
WinSyslog Event ID 11181: Queue manager: disk queue cache operation failed
==========================================================================
