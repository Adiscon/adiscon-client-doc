...
.. _winsyslog-event-id-11210:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11210: Product runtime: configured advanced feature is unavailable.
   :event-id: 11210
...
WinSyslog Event ID 11210: Product runtime: configured advanced feature is unavailable
=====================================================================================
...
- **Message pattern:** :spelling:ignore:`Cwinsyslog issupportedadvancedfeature. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11210 does not recur and that product runtime processing continues.
