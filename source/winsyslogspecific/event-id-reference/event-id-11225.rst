...
.. _winsyslog-event-id-11225:

.. meta::
   :description: Meaning and troubleshooting for WinSyslog Event ID 11225: RELP listener shutdown wake fallback.
   :event-id: 11225
...
WinSyslog Event ID 11225: RELP listener shutdown wake fallback
==============================================================
