.. _winsyslog-tutorial-export-config-and-debug-log:

Tutorial: Export the Configuration and Create a Debug Log
=========================================================

Use this tutorial when you need WinSyslog configuration data and a debug log
for troubleshooting or for a support case.
