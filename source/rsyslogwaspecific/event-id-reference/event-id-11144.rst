...
.. _rsyslog-event-id-11144:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11144: Syslog listener: listener could not bind to its configured address.
   :event-id: 11144
...
rsyslog Windows Agent Event ID 11144: Syslog listener: listener could not bind to its configured address
========================================================================================================
