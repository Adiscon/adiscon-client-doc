...
.. _rsyslog-event-id-11037:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11037: Action processing: runtime operation failed.
   :event-id: 11037
...
rsyslog Windows Agent Event ID 11037: Action processing: runtime operation failed
=================================================================================
...
- **Message pattern:** Cactionsendserial doaction.
