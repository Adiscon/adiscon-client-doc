...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11037: Send to Communications Port action could not write a byte.
   :event-id: 11037
...
rsyslog Windows Agent Event ID 11037: Send to Communications Port action could not write a byte
===============================================================================================
