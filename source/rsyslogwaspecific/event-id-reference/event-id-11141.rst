...
.. _rsyslog-event-id-11141:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11141: Syslog listener: BEEP listener option could not be applied.
   :event-id: 11141
...
rsyslog Windows Agent Event ID 11141: Syslog listener: BEEP listener option could not be applied
================================================================================================
