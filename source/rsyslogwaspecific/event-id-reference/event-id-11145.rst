...
.. _rsyslog-event-id-11145:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11145: Syslog listener: listener could not bind to its configured address.
   :event-id: 11145
...
rsyslog Windows Agent Event ID 11145: Syslog listener: listener could not bind to its configured address
========================================================================================================
