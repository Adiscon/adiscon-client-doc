...
.. _rsyslog-event-id-11199:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11199: TCP and TLS listener: TLS server initialization failed.
   :event-id: 11199
...
rsyslog Windows Agent Event ID 11199: TCP and TLS listener: TLS server initialization failed
============================================================================================

Answer
------

The tcp and tls listener reported a warning condition. The event detail identifies the affected operation and carries the specific runtime reason.
...
- **Message pattern:** Ctcpserver ssl connection initialization failed.
