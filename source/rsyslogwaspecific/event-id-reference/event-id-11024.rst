...
.. _rsyslog-event-id-11024:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11024: Action processing: runtime operation failed.
   :event-id: 11024
...
rsyslog Windows Agent Event ID 11024: Action processing: runtime operation failed
=================================================================================
...
- **Message pattern:** Cactionlistentry callaction.
