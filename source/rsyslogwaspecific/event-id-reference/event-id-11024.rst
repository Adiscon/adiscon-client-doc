...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11024: Configured action type is not recognized.
   :event-id: 11024
...
rsyslog Windows Agent Event ID 11024: Configured action type is not recognized
==============================================================================
