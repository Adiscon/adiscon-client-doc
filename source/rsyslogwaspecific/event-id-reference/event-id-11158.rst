...
.. _rsyslog-event-id-11158:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11158: Log rotation: runtime operation failed.
   :event-id: 11158
...
rsyslog Windows Agent Event ID 11158: Log rotation: runtime operation failed
============================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11158 does not recur and that log rotation processing continues.
