...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11158: Empty log-rotation queue file could not be deleted.
   :event-id: 11158
...
rsyslog Windows Agent Event ID 11158: Empty log-rotation queue file could not be deleted
========================================================================================
