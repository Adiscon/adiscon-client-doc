...
.. _rsyslog-event-id-11116:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11116: Passive Syslog listener stopped after an unknown exception.
   :event-id: 11116
   :event-product: rsyslog Windows Agent
   :event-severity: Error
   :event-component: Passive Syslog listener
   :event-reference: true

rsyslog Windows Agent Event ID 11116: Passive Syslog listener stopped after an unknown exception
================================================================================================
...
- **Message pattern:** :spelling:ignore:`The Passive Syslog listener encountered an unknown exception and stopped retrying.`
