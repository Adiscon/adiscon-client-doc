...
.. _rsyslog-event-id-11155:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11155: Log rotation: runtime operation failed.
   :event-id: 11155
...
rsyslog Windows Agent Event ID 11155: Log rotation: runtime operation failed
============================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11155 does not recur and that log rotation processing continues.
...
- :ref:`Event ID 11156 <rsyslog-event-id-11156>`
