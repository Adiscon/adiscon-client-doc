...
.. _rsyslog-event-id-11227:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11227: Event rejected after shutdown intake closed.
   :event-id: 11227
...
rsyslog Windows Agent Event ID 11227: Event rejected after shutdown intake closed
=================================================================================
