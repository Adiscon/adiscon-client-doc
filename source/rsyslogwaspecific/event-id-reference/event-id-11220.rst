...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11220: Control Windows Service action: runtime operation failed.
   :event-id: 11220
...
rsyslog Windows Agent Event ID 11220: Control Windows Service action: runtime operation failed
==============================================================================================
...
- **Message pattern:** Cactioncontrolntservice continue service failed.
