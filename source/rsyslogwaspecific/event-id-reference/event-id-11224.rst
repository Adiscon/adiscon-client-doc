...
.. _rsyslog-event-id-11224:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11224: Configuration reload shutdown incomplete.
   :event-id: 11224
...
rsyslog Windows Agent Event ID 11224: Configuration reload shutdown incomplete
==============================================================================
