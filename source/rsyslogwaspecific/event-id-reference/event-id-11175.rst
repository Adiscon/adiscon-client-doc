...
.. _rsyslog-event-id-11175:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11175: Queue manager: queue capacity condition.
   :event-id: 11175
...
rsyslog Windows Agent Event ID 11175: Queue manager: queue capacity condition
=============================================================================
