...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11016: SNMP action: runtime operation failed.
   :event-id: 11016
...
rsyslog Windows Agent Event ID 11016: SNMP action: runtime operation failed
===========================================================================
