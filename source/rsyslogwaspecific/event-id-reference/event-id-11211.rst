...
.. _rsyslog-event-id-11211:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11211: Product runtime: configured advanced feature is unavailable.
   :event-id: 11211
...
rsyslog Windows Agent Event ID 11211: Product runtime: configured advanced feature is unavailable
=================================================================================================
...
- **Message pattern:** :spelling:ignore:`Crsyslogclient issupportedadvancedfeature. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11211 does not recur and that product runtime processing continues.
...
- :ref:`Event ID 11152 <rsyslog-event-id-11152>`
- :ref:`Event ID 11169 <rsyslog-event-id-11169>`
- :ref:`Event ID 11194 <rsyslog-event-id-11194>`
