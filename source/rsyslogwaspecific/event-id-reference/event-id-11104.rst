...
.. _rsyslog-event-id-11104:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11104: Event Log Monitor service: Windows Event Log could not be cleared.
   :event-id: 11104
...
rsyslog Windows Agent Event ID 11104: Event Log Monitor service: Windows Event Log could not be cleared
=======================================================================================================
