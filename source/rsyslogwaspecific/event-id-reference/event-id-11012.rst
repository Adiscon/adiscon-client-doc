...
.. _rsyslog-event-id-11012:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11012: OLE DB action: database operation failed.
   :event-id: 11012
...
rsyslog Windows Agent Event ID 11012: OLE DB action: database operation failed
==============================================================================

Answer
------

OLE DB action: database operation failed. The product recorded this while processing ole db action; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11012 does not recur and that ole db action processing continues.
...
- :ref:`Event ID 11013 <rsyslog-event-id-11013>`
- :ref:`Event ID 11031 <rsyslog-event-id-11031>`
- :ref:`Event ID 11032 <rsyslog-event-id-11032>`
