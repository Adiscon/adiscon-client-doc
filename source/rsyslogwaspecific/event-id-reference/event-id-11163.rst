...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11163: Persisted log-rotation queue file could not be read.
   :event-id: 11163
...
rsyslog Windows Agent Event ID 11163: Persisted log-rotation queue file could not be read
=========================================================================================
