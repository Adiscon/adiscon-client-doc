...
.. _rsyslog-event-id-11163:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11163: Log rotation: runtime operation failed.
   :event-id: 11163
...
rsyslog Windows Agent Event ID 11163: Log rotation: runtime operation failed
============================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11163 does not recur and that log rotation processing continues.
