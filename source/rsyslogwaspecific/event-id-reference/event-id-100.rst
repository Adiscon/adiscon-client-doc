...
.. _rsyslog-event-id-100:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 100: The service was installed.
   :event-id: 100
...
rsyslog Windows Agent Event ID 100: The service was installed
=============================================================
...
- **Message pattern:** The service was installed.
