...
.. _rsyslog-event-id-11014:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11014: Action processing: action initialization failed.
   :event-id: 11014
...
rsyslog Windows Agent Event ID 11014: Action processing: action initialization failed
=====================================================================================

Answer
------

Action processing: action initialization failed. The product recorded this while processing action processing; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`Action processing: action initialization failed. Additional detail: {event_detail}`
...
- :ref:`Event ID 11022 <rsyslog-event-id-11022>`
