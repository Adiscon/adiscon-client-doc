...
.. _rsyslog-event-id-11086:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11086: HTTP Probe service: probe operation raised an exception.
   :event-id: 11086
...
rsyslog Windows Agent Event ID 11086: HTTP Probe service: probe operation raised an exception
=============================================================================================
