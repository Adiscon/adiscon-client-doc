...
- **Message pattern:** :spelling:ignore:`HTTP Probe service: probe operation raised an exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11087 <rsyslog-event-id-11087>`
