...
.. _rsyslog-event-id-11120:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11120: POP3 Probe service: probe operation raised an unknown exception.
   :event-id: 11120
...
rsyslog Windows Agent Event ID 11120: POP3 Probe service: probe operation raised an unknown exception
=====================================================================================================

Answer
------

POP3 Probe service: probe operation raised an unknown exception. The product recorded this while processing pop3 probe service; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11120 does not recur and that pop3 probe service processing continues.
...
- :ref:`Event ID 11119 <rsyslog-event-id-11119>`
