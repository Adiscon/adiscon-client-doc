...
.. _rsyslog-event-id-11069:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11069: Database Monitor service: database operation failed.
   :event-id: 11069
...
rsyslog Windows Agent Event ID 11069: Database Monitor service: database operation failed
=========================================================================================
...
- **Message pattern:** :spelling:ignore:`Database Monitor service: database operation failed. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11069 does not recur and that database monitor service processing continues.
...
- :ref:`Event ID 11066 <rsyslog-event-id-11066>`
- :ref:`Event ID 11067 <rsyslog-event-id-11067>`
- :ref:`Event ID 11068 <rsyslog-event-id-11068>`
