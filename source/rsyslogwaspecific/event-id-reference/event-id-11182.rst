...
.. _rsyslog-event-id-11182:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11182: Queue manager: disk queue cache operation failed.
   :event-id: 11182
...
rsyslog Windows Agent Event ID 11182: Queue manager: disk queue cache operation failed
======================================================================================
...
- **Message pattern:** Cquemanlist processqueueditems.
...
Repeat or monitor the affected operation and confirm that Event ID 11182 does not recur and that queue manager processing continues.
