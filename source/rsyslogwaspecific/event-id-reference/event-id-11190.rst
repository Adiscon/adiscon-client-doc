...
.. _rsyslog-event-id-11190:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11190: Service configuration: configured feature is unavailable.
   :event-id: 11190
...
rsyslog Windows Agent Event ID 11190: Service configuration: configured feature is unavailable
==============================================================================================
...
- **Message pattern:** :spelling:ignore:`Service configuration: configured feature is unavailable. Additional detail: {event_detail}`
