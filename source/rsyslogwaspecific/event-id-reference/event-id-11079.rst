...
.. _rsyslog-event-id-11079:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11079: File Monitor service: configured file could not be opened.
   :event-id: 11079
...
rsyslog Windows Agent Event ID 11079: File Monitor service: configured file could not be opened
===============================================================================================
