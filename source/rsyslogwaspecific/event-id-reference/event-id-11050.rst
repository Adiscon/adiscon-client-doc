...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11050: Network and TLS transport: TLS operation warning.
   :event-id: 11050
...
rsyslog Windows Agent Event ID 11050: Network and TLS transport: TLS operation warning
======================================================================================
