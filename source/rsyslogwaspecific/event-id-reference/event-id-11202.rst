...
.. _rsyslog-event-id-11202:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11202: TCP and TLS listener: runtime operation failed.
   :event-id: 11202
...
rsyslog Windows Agent Event ID 11202: TCP and TLS listener: runtime operation failed
====================================================================================
...
- **Message pattern:** Ctcpserver runserver.
