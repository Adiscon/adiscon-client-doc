...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11202: TCP listener could not assign an accepted socket.
   :event-id: 11202
...
rsyslog Windows Agent Event ID 11202: TCP listener could not assign an accepted socket
======================================================================================
