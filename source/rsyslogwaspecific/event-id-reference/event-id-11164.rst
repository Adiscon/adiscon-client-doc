...
.. _rsyslog-event-id-11164:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11164: Email action: invalid SMTP recipient address.
   :event-id: 11164
...
rsyslog Windows Agent Event ID 11164: Email action: invalid SMTP recipient address
==================================================================================
...
- :ref:`Event ID 11165 <rsyslog-event-id-11165>`
