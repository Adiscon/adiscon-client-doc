...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11170: Queue manager: runtime operation failed.
   :event-id: 11170
...
rsyslog Windows Agent Event ID 11170: Queue manager: runtime operation failed
=============================================================================
