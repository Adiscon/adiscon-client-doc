...
.. _rsyslog-event-id-11178:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11178: Queue manager: disk queue cache operation failed.
   :event-id: 11178
...
rsyslog Windows Agent Event ID 11178: Queue manager: disk queue cache operation failed
======================================================================================
