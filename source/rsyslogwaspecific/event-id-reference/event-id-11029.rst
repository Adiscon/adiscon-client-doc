...
.. _rsyslog-event-id-11029:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11029: ODBC database action: database operation failed.
   :event-id: 11029
...
rsyslog Windows Agent Event ID 11029: ODBC database action: database operation failed
=====================================================================================
