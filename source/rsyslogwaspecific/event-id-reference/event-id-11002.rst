...
.. _rsyslog-event-id-11002:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11002: SETP delivery delayed in the action cache.
   :event-id: 11002
...
rsyslog Windows Agent Event ID 11002: SETP delivery delayed in the action cache
===============================================================================
...
- :ref:`Event ID 11003 <rsyslog-event-id-11003>`
