...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11027: Configured action raised an unknown exception at its retry limit.
   :event-id: 11027
...
rsyslog Windows Agent Event ID 11027: Configured action raised an unknown exception at its retry limit
======================================================================================================
