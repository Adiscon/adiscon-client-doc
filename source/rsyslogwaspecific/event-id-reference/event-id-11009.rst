...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11009: A queued action message could not be delivered.
   :event-id: 11009
...
rsyslog Windows Agent Event ID 11009: A queued action message could not be delivered
====================================================================================
