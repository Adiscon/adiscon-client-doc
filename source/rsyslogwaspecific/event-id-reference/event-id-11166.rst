...
.. _rsyslog-event-id-11166:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11166: OLE DB action: OLE DB operation failed.
   :event-id: 11166
...
rsyslog Windows Agent Event ID 11166: OLE DB action: OLE DB operation failed
============================================================================
