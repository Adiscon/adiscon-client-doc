...
.. _rsyslog-event-id-11060:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11060: MonitorWare Echo service: MonitorWare Echo operation raised an exception.
   :event-id: 11060
...
rsyslog Windows Agent Event ID 11060: MonitorWare Echo service: MonitorWare Echo operation raised an exception
==============================================================================================================
