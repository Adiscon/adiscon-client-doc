...
.. _rsyslog-event-id-11201:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11201: TCP and TLS listener: TCP listener fatal error.
   :event-id: 11201
...
rsyslog Windows Agent Event ID 11201: TCP and TLS listener: TCP listener fatal error
====================================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11201 does not recur and that tcp and tls listener processing continues.
