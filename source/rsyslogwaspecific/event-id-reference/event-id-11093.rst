...
.. _rsyslog-event-id-11093:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11093: SETP receiver: SETP operation raised an exception.
   :event-id: 11093
...
rsyslog Windows Agent Event ID 11093: SETP receiver: SETP operation raised an exception
=======================================================================================
