...
.. _rsyslog-event-id-11132:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11132: SNMP Monitor service: SNMP operation raised an exception.
   :event-id: 11132
...
rsyslog Windows Agent Event ID 11132: SNMP Monitor service: SNMP operation raised an exception
==============================================================================================
