...
.. _rsyslog-event-id-11026:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11026: Action processing: runtime operation failed.
   :event-id: 11026
...
rsyslog Windows Agent Event ID 11026: Action processing: runtime operation failed
=================================================================================
...
- **Message pattern:** Ruleengine actions. Additional detail: {event_detail}
...
Repeat or monitor the affected operation and confirm that Event ID 11026 does not recur and that action processing processing continues.
