...
.. _rsyslog-event-id-11217:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11217: Control Windows Service action could not start the target service.
   :event-id: 11217
...
rsyslog Windows Agent Event ID 11217: Control Windows Service action could not start the target service
=======================================================================================================
