...
.. _rsyslog-event-id-11048:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11048: Network and TLS transport: unknown runtime error.
   :event-id: 11048
...
rsyslog Windows Agent Event ID 11048: Network and TLS transport: unknown runtime error
======================================================================================
...
- :doc:`Event ID 11051 <event-id-11051>`
