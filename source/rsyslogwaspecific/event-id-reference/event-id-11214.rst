...
.. _rsyslog-event-id-11214:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11214: System exception in the queue worker thread.
   :event-id: 11214
...
rsyslog Windows Agent Event ID 11214: System exception in the queue worker thread
=================================================================================
