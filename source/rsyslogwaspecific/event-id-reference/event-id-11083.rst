...
.. _rsyslog-event-id-11083:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11083: FTP Probe service: probe operation raised an unknown exception.
   :event-id: 11083
...
rsyslog Windows Agent Event ID 11083: FTP Probe service: probe operation raised an unknown exception
====================================================================================================
...
- :ref:`Event ID 11082 <rsyslog-event-id-11082>`
