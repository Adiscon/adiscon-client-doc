...
.. _rsyslog-event-id-11193:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11193: Service configuration: service configuration raised an unknown exception.
   :event-id: 11193
...
rsyslog Windows Agent Event ID 11193: Service configuration: service configuration raised an unknown exception
==============================================================================================================

Answer
------

Service configuration: service configuration raised an unknown exception. The product recorded this while processing service configuration; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11193 does not recur and that service configuration processing continues.
