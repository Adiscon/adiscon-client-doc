...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11156: Rotated log could not be moved to its archive destination.
   :event-id: 11156
...
rsyslog Windows Agent Event ID 11156: Rotated log could not be moved to its archive destination
===============================================================================================
