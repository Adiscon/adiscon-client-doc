...
.. _rsyslog-event-id-11149:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11149: Event Log Monitor V2 service: general runtime error.
   :event-id: 11149
...
rsyslog Windows Agent Event ID 11149: Event Log Monitor V2 service: general runtime error
=========================================================================================
