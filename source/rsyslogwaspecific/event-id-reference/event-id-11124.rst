...
.. _rsyslog-event-id-11124:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11124: Serial Port Monitor: serial port operation raised an exception.
   :event-id: 11124
...
rsyslog Windows Agent Event ID 11124: Serial Port Monitor: serial port operation raised an exception
====================================================================================================
...
- :ref:`Event ID 11125 <rsyslog-event-id-11125>`
