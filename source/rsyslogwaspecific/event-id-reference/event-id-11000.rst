...
.. _rsyslog-event-id-11000:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11000: SETP connection closed by the receiver.
   :event-id: 11000
...
rsyslog Windows Agent Event ID 11000: SETP connection closed by the receiver
============================================================================
