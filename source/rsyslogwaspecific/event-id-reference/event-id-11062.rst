...
.. _rsyslog-event-id-11062:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11062: MonitorWare Echo service: MonitorWare Echo operation raised an exception.
   :event-id: 11062
...
rsyslog Windows Agent Event ID 11062: MonitorWare Echo service: MonitorWare Echo operation raised an exception
==============================================================================================================
...
- :ref:`Event ID 11063 <rsyslog-event-id-11063>`
