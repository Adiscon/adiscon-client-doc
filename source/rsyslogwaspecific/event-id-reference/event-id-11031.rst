...
.. _rsyslog-event-id-11031:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11031: OLE DB action: database operation failed.
   :event-id: 11031
...
rsyslog Windows Agent Event ID 11031: OLE DB action: database operation failed
==============================================================================
