...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11189: Input service could not find its assigned ruleset.
   :event-id: 11189
...
rsyslog Windows Agent Event ID 11189: Input service could not find its assigned ruleset
=======================================================================================
