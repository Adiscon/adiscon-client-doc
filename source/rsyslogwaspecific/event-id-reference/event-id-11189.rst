...
.. _rsyslog-event-id-11189:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11189: Service configuration: runtime operation failed.
   :event-id: 11189
...
rsyslog Windows Agent Event ID 11189: Service configuration: runtime operation failed
=====================================================================================
...
- **Message pattern:** Servicemanager no rule base.
