...
.. _rsyslog-event-id-11010:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11010: ODBC database action: database operation failed.
   :event-id: 11010
...
rsyslog Windows Agent Event ID 11010: ODBC database action: database operation failed
=====================================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11010 does not recur and that odbc database action processing continues.
...
- :ref:`Event ID 11030 <rsyslog-event-id-11030>`
