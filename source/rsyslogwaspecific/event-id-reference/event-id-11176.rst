...
.. _rsyslog-event-id-11176:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11176: Main message queue is full.
   :event-id: 11176
...
rsyslog Windows Agent Event ID 11176: Main message queue is full
================================================================

Answer
------

Main message queue is full. The product recorded this while processing queue manager; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11176 does not recur and that queue manager processing continues.
...
- :ref:`Event ID 11170 <rsyslog-event-id-11170>`
