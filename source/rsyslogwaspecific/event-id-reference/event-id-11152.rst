...
.. _rsyslog-event-id-11152:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11152: Product runtime: runtime operation failed.
   :event-id: 11152
...
rsyslog Windows Agent Event ID 11152: Product runtime: runtime operation failed
===============================================================================
...
- **Message pattern:** :spelling:ignore:`Infounit. Additional detail: {event_detail}`
