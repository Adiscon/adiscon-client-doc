...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11152: A queued event has an unsupported information-unit type.
   :event-id: 11152
...
rsyslog Windows Agent Event ID 11152: A queued event has an unsupported information-unit type
=============================================================================================
