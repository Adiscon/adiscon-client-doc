...
.. _rsyslog-event-id-11150:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11150: Event Log Monitor V2 service: Windows Event Log operation failed.
   :event-id: 11150
...
rsyslog Windows Agent Event ID 11150: Event Log Monitor V2 service: Windows Event Log operation failed
======================================================================================================
