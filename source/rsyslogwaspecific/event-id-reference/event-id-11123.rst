...
.. _rsyslog-event-id-11123:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11123: Serial Port Monitor: serial port operation failed.
   :event-id: 11123
...
rsyslog Windows Agent Event ID 11123: Serial Port Monitor: serial port operation failed
=======================================================================================
