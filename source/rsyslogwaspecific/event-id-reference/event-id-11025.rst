...
.. _rsyslog-event-id-11025:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11025: Action processing: invalid action type in configuration.
   :event-id: 11025
...
rsyslog Windows Agent Event ID 11025: Action processing: invalid action type in configuration
=============================================================================================

Answer
------

Action processing: invalid action type in configuration. The product recorded this while processing action processing; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11025 does not recur and that action processing processing continues.
