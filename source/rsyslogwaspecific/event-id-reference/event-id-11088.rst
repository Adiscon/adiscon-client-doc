...
.. _rsyslog-event-id-11088:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11088: IMAP Probe service: probe operation raised an exception.
   :event-id: 11088
...
rsyslog Windows Agent Event ID 11088: IMAP Probe service: probe operation raised an exception
=============================================================================================

Answer
------

IMAP Probe service: probe operation raised an exception. The product recorded this while processing imap probe service; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`IMAP Probe service: probe operation raised an exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11089 <rsyslog-event-id-11089>`
