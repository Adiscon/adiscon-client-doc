...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11159: Log rotation: runtime operation failed.
   :event-id: 11159
...
rsyslog Windows Agent Event ID 11159: Log rotation: runtime operation failed
============================================================================
