...
.. _rsyslog-event-id-11159:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11159: Corrupt log-rotation queue file could not be quarantined.
   :event-id: 11159
...
rsyslog Windows Agent Event ID 11159: Corrupt log-rotation queue file could not be quarantined
==============================================================================================
