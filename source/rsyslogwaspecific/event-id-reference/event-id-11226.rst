...
.. _rsyslog-event-id-11226:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11226: SNMP listener shutdown wake fallback.
   :event-id: 11226
...
rsyslog Windows Agent Event ID 11226: SNMP listener shutdown wake fallback
==========================================================================
