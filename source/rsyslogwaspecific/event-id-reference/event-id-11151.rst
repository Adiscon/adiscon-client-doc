...
.. _rsyslog-event-id-11151:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11151: Event Log Monitor V2 service: Windows Event Log operation failed.
   :event-id: 11151
...
rsyslog Windows Agent Event ID 11151: Event Log Monitor V2 service: Windows Event Log operation failed
======================================================================================================
