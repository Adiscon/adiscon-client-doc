...
.. _rsyslog-event-id-11179:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11179: Queue manager: disk queue cache operation failed.
   :event-id: 11179
...
rsyslog Windows Agent Event ID 11179: Queue manager: disk queue cache operation failed
======================================================================================
...
- **Message pattern:** Cquemanlist initringbufferfile.
...
Repeat or monitor the affected operation and confirm that Event ID 11179 does not recur and that queue manager processing continues.
