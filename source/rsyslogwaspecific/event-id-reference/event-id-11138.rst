...
.. _rsyslog-event-id-11138:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11138: SNMP Trap Receiver: SNMP operation raised an exception.
   :event-id: 11138
...
rsyslog Windows Agent Event ID 11138: SNMP Trap Receiver: SNMP operation raised an exception
============================================================================================
...
- :ref:`Event ID 11140 <rsyslog-event-id-11140>`
