...
.. _rsyslog-event-id-11096:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11096: NNTP Probe service: probe operation raised an unknown exception.
   :event-id: 11096
...
rsyslog Windows Agent Event ID 11096: NNTP Probe service: probe operation raised an unknown exception
=====================================================================================================
...
- **Message pattern:** NNTP Probe service: probe operation raised an unknown exception. Additional detail: {event_detail}
...
- :ref:`Event ID 11095 <rsyslog-event-id-11095>`
