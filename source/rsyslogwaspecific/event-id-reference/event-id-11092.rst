...
.. _rsyslog-event-id-11092:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11092: SETP receiver: SETP operation raised an exception.
   :event-id: 11092
...
rsyslog Windows Agent Event ID 11092: SETP receiver: SETP operation raised an exception
=======================================================================================
