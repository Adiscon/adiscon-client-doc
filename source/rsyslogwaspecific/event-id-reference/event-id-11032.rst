...
.. _rsyslog-event-id-11032:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11032: OLE DB action: OLE DB operation failed.
   :event-id: 11032
...
rsyslog Windows Agent Event ID 11032: OLE DB action: OLE DB operation failed
============================================================================
