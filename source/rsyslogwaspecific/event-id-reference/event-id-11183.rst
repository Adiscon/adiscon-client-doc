...
.. _rsyslog-event-id-11183:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11183: Service configuration: runtime operation failed.
   :event-id: 11183
...
rsyslog Windows Agent Event ID 11183: Service configuration: runtime operation failed
=====================================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11183 does not recur and that service configuration processing continues.
...
- :ref:`Event ID 11186 <rsyslog-event-id-11186>`
