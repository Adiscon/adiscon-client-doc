...
.. _rsyslog-event-id-11174:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11174: Queue manager: queue capacity condition.
   :event-id: 11174
...
rsyslog Windows Agent Event ID 11174: Queue manager: queue capacity condition
=============================================================================
