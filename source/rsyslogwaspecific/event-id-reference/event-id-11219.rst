...
.. _rsyslog-event-id-11219:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11219: Control Windows Service action: runtime operation failed.
   :event-id: 11219
...
rsyslog Windows Agent Event ID 11219: Control Windows Service action: runtime operation failed
==============================================================================================
...
- **Message pattern:** Cactioncontrolntservice pause service failed.
...
Repeat or monitor the affected operation and confirm that Event ID 11219 does not recur and that control windows service action processing continues.
