...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11041: Start Program action: runtime operation failed.
   :event-id: 11041
...
rsyslog Windows Agent Event ID 11041: Start Program action: runtime operation failed
====================================================================================
