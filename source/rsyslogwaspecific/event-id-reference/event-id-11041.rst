...
.. _rsyslog-event-id-11041:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11041: Start Program action received an unexpected wait result.
   :event-id: 11041
...
rsyslog Windows Agent Event ID 11041: Start Program action received an unexpected wait result
=============================================================================================
