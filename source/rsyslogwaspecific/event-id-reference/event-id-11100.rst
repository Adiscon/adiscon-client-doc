...
.. _rsyslog-event-id-11100:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11100: Event Log Monitor service: runtime operation failed.
   :event-id: 11100
...
rsyslog Windows Agent Event ID 11100: Event Log Monitor service: runtime operation failed
=========================================================================================

Answer
------

The event log monitor service reported a warning condition. The event detail identifies the affected operation and carries the specific runtime reason.
