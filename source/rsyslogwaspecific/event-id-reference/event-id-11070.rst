...
.. _rsyslog-event-id-11070:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11070: Database Monitor service: database operation failed.
   :event-id: 11070
...
rsyslog Windows Agent Event ID 11070: Database Monitor service: database operation failed
=========================================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11070 does not recur and that database monitor service processing continues.
