...
.. _rsyslog-event-id-11106:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11106: Windows Event Log cleared and saved.
   :event-id: 11106
...
rsyslog Windows Agent Event ID 11106: Windows Event Log cleared and saved
=========================================================================
...
- **Message pattern:** Windows Event Log cleared and saved. Additional detail: {event_detail}
...
- :ref:`Event ID 11107 <rsyslog-event-id-11107>`
