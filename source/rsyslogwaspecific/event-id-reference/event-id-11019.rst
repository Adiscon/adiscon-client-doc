...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11019: Syslog Queue action has no queue name.
   :event-id: 11019
...
rsyslog Windows Agent Event ID 11019: Syslog Queue action has no queue name
===========================================================================
