...
.. _rsyslog-event-id-11198:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11198: TCP and TLS listener: TCP listener fatal error.
   :event-id: 11198
...
rsyslog Windows Agent Event ID 11198: TCP and TLS listener: TCP listener fatal error
====================================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11198 does not recur and that tcp and tls listener processing continues.
...
- :ref:`Event ID 11200 <rsyslog-event-id-11200>`
