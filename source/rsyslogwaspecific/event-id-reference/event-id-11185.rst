...
.. _rsyslog-event-id-11185:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11185: Service configuration: runtime operation failed.
   :event-id: 11185
...
rsyslog Windows Agent Event ID 11185: Service configuration: runtime operation failed
=====================================================================================
