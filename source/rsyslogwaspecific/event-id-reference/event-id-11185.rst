...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11185: No product input service is configured.
   :event-id: 11185
...
rsyslog Windows Agent Event ID 11185: No product input service is configured
============================================================================
