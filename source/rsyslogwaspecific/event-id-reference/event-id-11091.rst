...
.. _rsyslog-event-id-11091:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11091: SETP receiver: SETP operation raised an exception.
   :event-id: 11091
...
rsyslog Windows Agent Event ID 11091: SETP receiver: SETP operation raised an exception
=======================================================================================

Answer
------

The setp receiver reported a warning condition. The event detail identifies the affected operation and carries the specific runtime reason.
