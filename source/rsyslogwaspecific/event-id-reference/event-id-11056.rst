...
.. _rsyslog-event-id-11056:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11056: Network and TLS transport: TLS operation warning.
   :event-id: 11056
...
rsyslog Windows Agent Event ID 11056: Network and TLS transport: TLS operation warning
======================================================================================
