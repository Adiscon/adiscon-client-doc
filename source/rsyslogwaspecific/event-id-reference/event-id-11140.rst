...
.. _rsyslog-event-id-11140:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11140: SNMP Trap Receiver: SNMP operation raised an unknown exception.
   :event-id: 11140
...
rsyslog Windows Agent Event ID 11140: SNMP Trap Receiver: SNMP operation raised an unknown exception
====================================================================================================

Answer
------

SNMP Trap Receiver: SNMP operation raised an unknown exception. The product recorded this while processing snmp trap receiver; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`SNMP Trap Receiver: SNMP operation raised an unknown exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11137 <rsyslog-event-id-11137>`
- :ref:`Event ID 11138 <rsyslog-event-id-11138>`
- :ref:`Event ID 11139 <rsyslog-event-id-11139>`
