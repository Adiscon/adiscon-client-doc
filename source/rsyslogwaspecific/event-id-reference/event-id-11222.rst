...
.. _rsyslog-event-id-11222:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11222: Log rotation: runtime operation failed.
   :event-id: 11222
...
rsyslog Windows Agent Event ID 11222: Log rotation: runtime operation failed
============================================================================
...
- **Message pattern:** Logrotationsubsystem consumed queue delete failed. Additional detail: {event_detail}
