...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11222: Consumed log-rotation queue file could not be deleted.
   :event-id: 11222
...
rsyslog Windows Agent Event ID 11222: Consumed log-rotation queue file could not be deleted
===========================================================================================
