...
.. _rsyslog-event-id-11218:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11218: Control Windows Service action: runtime operation failed.
   :event-id: 11218
...
rsyslog Windows Agent Event ID 11218: Control Windows Service action: runtime operation failed
==============================================================================================
...
- **Message pattern:** Cactioncontrolntservice stop service failed.
