...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11055: TLS client certificate fingerprint could not be computed.
   :event-id: 11055
...
rsyslog Windows Agent Event ID 11055: TLS client certificate fingerprint could not be computed
==============================================================================================
