...
.. _rsyslog-event-id-11065:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11065: CPU Monitor service: CPU monitor raised an unknown exception.
   :event-id: 11065
...
rsyslog Windows Agent Event ID 11065: CPU Monitor service: CPU monitor raised an unknown exception
==================================================================================================

Answer
------

CPU Monitor service: CPU monitor raised an unknown exception. The product recorded this while processing cpu monitor service; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11065 does not recur and that cpu monitor service processing continues.
...
- :ref:`Event ID 11064 <rsyslog-event-id-11064>`
