...
.. _rsyslog-event-id-11021:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11021: Action processing: configured action feature is unavailable.
   :event-id: 11021
...
rsyslog Windows Agent Event ID 11021: Action processing: configured action feature is unavailable
=================================================================================================
