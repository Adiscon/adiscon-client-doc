...
.. _rsyslog-event-id-11139:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11139: SNMP Trap Receiver: SNMP operation raised an exception.
   :event-id: 11139
...
rsyslog Windows Agent Event ID 11139: SNMP Trap Receiver: SNMP operation raised an exception
============================================================================================
