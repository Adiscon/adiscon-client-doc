...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11157: Log rotation: runtime operation failed.
   :event-id: 11157
...
rsyslog Windows Agent Event ID 11157: Log rotation: runtime operation failed
============================================================================
