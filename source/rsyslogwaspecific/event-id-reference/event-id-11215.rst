...
.. _rsyslog-event-id-11215:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11215: Debug error output was forwarded to the Windows Event Log.
   :event-id: 11215
...
rsyslog Windows Agent Event ID 11215: Debug error output was forwarded to the Windows Event Log
===============================================================================================
