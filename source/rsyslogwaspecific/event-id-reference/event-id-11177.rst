...
.. _rsyslog-event-id-11177:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11177: Queue manager: queue capacity condition.
   :event-id: 11177
...
rsyslog Windows Agent Event ID 11177: Queue manager: queue capacity condition
=============================================================================
