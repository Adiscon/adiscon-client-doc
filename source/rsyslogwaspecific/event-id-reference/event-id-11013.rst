...
.. _rsyslog-event-id-11013:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11013: OLE DB action: OLE DB operation failed.
   :event-id: 11013
...
rsyslog Windows Agent Event ID 11013: OLE DB action: OLE DB operation failed
============================================================================
...
- **Message pattern:** OLE DB action: OLE DB operation failed. Additional detail: {event_detail}
...
Repeat or monitor the affected operation and confirm that Event ID 11013 does not recur and that ole db action processing continues.
...
- :ref:`Event ID 11012 <rsyslog-event-id-11012>`
