...
.. _rsyslog-event-id-11121:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11121: RELP listener: listener could not bind to its configured address.
   :event-id: 11121
...
rsyslog Windows Agent Event ID 11121: RELP listener: listener could not bind to its configured address
======================================================================================================

Answer
------

RELP listener: listener could not bind to its configured address. The product recorded this while processing relp listener; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11121 does not recur and that relp listener processing continues.
...
- :ref:`Event ID 11122 <rsyslog-event-id-11122>`
