...
.. _rsyslog-event-id-11172:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11172: Queue manager: unknown runtime error.
   :event-id: 11172
...
rsyslog Windows Agent Event ID 11172: Queue manager: unknown runtime error
==========================================================================
