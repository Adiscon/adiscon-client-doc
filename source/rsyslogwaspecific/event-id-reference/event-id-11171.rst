...
.. _rsyslog-event-id-11171:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11171: Queue manager: unknown runtime error.
   :event-id: 11171
...
rsyslog Windows Agent Event ID 11171: Queue manager: unknown runtime error
==========================================================================
