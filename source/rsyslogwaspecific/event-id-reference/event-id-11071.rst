...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11071: Disk Space Monitor could not complete a disk-space check.
   :event-id: 11071
...
rsyslog Windows Agent Event ID 11071: Disk Space Monitor could not complete a disk-space check
==============================================================================================
