...
.. _rsyslog-event-id-11052:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11052: Network and TLS transport: TLS operation warning.
   :event-id: 11052
...
rsyslog Windows Agent Event ID 11052: Network and TLS transport: TLS operation warning
======================================================================================
