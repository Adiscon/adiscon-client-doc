...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11052: TLS client certificate identity is unavailable.
   :event-id: 11052
...
rsyslog Windows Agent Event ID 11052: TLS client certificate identity is unavailable
====================================================================================
