...
.. _rsyslog-event-id-11223:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11223: Protected service shutdown deadline expired.
   :event-id: 11223
...
rsyslog Windows Agent Event ID 11223: Protected service shutdown deadline expired
=================================================================================
...
- :ref:`Event ID 11227 <rsyslog-event-id-11227>`
