...
.. _rsyslog-event-id-11168:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11168: Runtime resource management: memory allocation failed.
   :event-id: 11168
...
rsyslog Windows Agent Event ID 11168: Runtime resource management: memory allocation failed
===========================================================================================

Answer
------

Runtime resource management: memory allocation failed. The product recorded this while processing runtime resource management; the appended event detail identifies the affected object, operation, or provider error.
...
- :ref:`Event ID 11167 <rsyslog-event-id-11167>`
