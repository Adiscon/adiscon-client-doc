...
.. _rsyslog-event-id-11011:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11011: ODBC database action: database operation failed.
   :event-id: 11011
...
rsyslog Windows Agent Event ID 11011: ODBC database action: database operation failed
=====================================================================================
