...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11054: TLS certificate-name authentication has no permitted peers.
   :event-id: 11054
...
rsyslog Windows Agent Event ID 11054: TLS certificate-name authentication has no permitted peers
================================================================================================
