...
.. _rsyslog-event-id-11054:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11054: Network and TLS transport: TLS operation warning.
   :event-id: 11054
...
rsyslog Windows Agent Event ID 11054: Network and TLS transport: TLS operation warning
======================================================================================
...
- **Message pattern:** Cwinsock initopensslserversession.
...
Repeat or monitor the affected operation and confirm that Event ID 11054 does not recur and that network and tls transport processing continues.
