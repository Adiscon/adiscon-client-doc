...
.. _rsyslog-event-id-11039:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11039: Forward Syslog delivery failed and the message was queued.
   :event-id: 11039
...
rsyslog Windows Agent Event ID 11039: Forward Syslog delivery failed and the message was queued
===============================================================================================
