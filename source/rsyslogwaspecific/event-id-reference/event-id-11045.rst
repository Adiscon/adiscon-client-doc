...
.. _rsyslog-event-id-11045:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11045: File-based configuration: file-based configuration could not be loaded.
   :event-id: 11045
...
rsyslog Windows Agent Event ID 11045: File-based configuration: file-based configuration could not be loaded
============================================================================================================
...
- :ref:`Event ID 11046 <rsyslog-event-id-11046>`
