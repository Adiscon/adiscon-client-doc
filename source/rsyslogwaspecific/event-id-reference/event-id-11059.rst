...
.. _rsyslog-event-id-11059:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11059: Monitoring service: service component initialization failed.
   :event-id: 11059
...
rsyslog Windows Agent Event ID 11059: Monitoring service: service component initialization failed
=================================================================================================
...
- **Message pattern:** :spelling:ignore:`Monitoring service: service component initialization failed. Additional detail: {event_detail}`
