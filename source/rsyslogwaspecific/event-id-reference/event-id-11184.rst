...
.. _rsyslog-event-id-11184:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11184: Service configuration: memory reserve could not be allocated.
   :event-id: 11184
...
rsyslog Windows Agent Event ID 11184: Service configuration: memory reserve could not be allocated
==================================================================================================
