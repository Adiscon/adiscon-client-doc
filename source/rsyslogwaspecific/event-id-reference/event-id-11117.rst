...
.. _rsyslog-event-id-11117:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11117: Ping Probe service stopped after a reported runtime error.
   :event-id: 11117
...
rsyslog Windows Agent Event ID 11117: Ping Probe service stopped after a reported runtime error
===============================================================================================
...
- :ref:`Event ID 11118 <rsyslog-event-id-11118>`
