...
.. _rsyslog-event-id-11147:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11147: Event Log Monitor V2 service: required timer could not be created.
   :event-id: 11147
...
rsyslog Windows Agent Event ID 11147: Event Log Monitor V2 service: required timer could not be created
=======================================================================================================
