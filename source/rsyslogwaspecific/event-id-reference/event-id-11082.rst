...
.. _rsyslog-event-id-11082:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11082: FTP Probe service: probe operation raised an exception.
   :event-id: 11082
...
rsyslog Windows Agent Event ID 11082: FTP Probe service: probe operation raised an exception
============================================================================================

Answer
------

FTP Probe service: probe operation raised an exception. The product recorded this while processing ftp probe service; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`FTP Probe service: probe operation raised an exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11083 <rsyslog-event-id-11083>`
