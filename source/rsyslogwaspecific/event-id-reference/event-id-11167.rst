...
.. _rsyslog-event-id-11167:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11167: Runtime resource management: memory reserve is in use.
   :event-id: 11167
...
rsyslog Windows Agent Event ID 11167: Runtime resource management: memory reserve is in use
===========================================================================================

Answer
------

Runtime resource management: memory reserve is in use. The product recorded this while processing runtime resource management; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11167 does not recur and that runtime resource management processing continues.
...
- :ref:`Event ID 11168 <rsyslog-event-id-11168>`
