...
.. _rsyslog-event-id-11107:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11107: Windows Event Log cleared.
   :event-id: 11107
...
rsyslog Windows Agent Event ID 11107: Windows Event Log cleared
===============================================================
...
- **Message pattern:** :spelling:ignore:`Windows Event Log cleared. Additional detail: {event_detail}`
...
- :ref:`Event ID 11106 <rsyslog-event-id-11106>`
