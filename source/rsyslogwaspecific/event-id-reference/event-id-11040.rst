...
.. _rsyslog-event-id-11040:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11040: Forward Syslog action: runtime operation failed.
   :event-id: 11040
...
rsyslog Windows Agent Event ID 11040: Forward Syslog action: runtime operation failed
=====================================================================================

Answer
------

The forward syslog action reported an error condition. The event detail identifies the affected operation and carries the specific runtime reason.
...
Repeat or monitor the affected operation and confirm that Event ID 11040 does not recur and that forward syslog action processing continues.
