...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11173: An event failed while the main queue applied its rules.
   :event-id: 11173
...
rsyslog Windows Agent Event ID 11173: An event failed while the main queue applied its rules
============================================================================================
