...
.. _rsyslog-event-id-11200:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11200: TCP and TLS listener: TCP listener fatal error.
   :event-id: 11200
...
rsyslog Windows Agent Event ID 11200: TCP and TLS listener: TCP listener fatal error
====================================================================================

Answer
------

TCP and TLS listener: TCP listener fatal error. The product recorded this while processing tcp and tls listener; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11200 does not recur and that tcp and tls listener processing continues.
...
- :ref:`Event ID 11198 <rsyslog-event-id-11198>`
- :ref:`Event ID 11199 <rsyslog-event-id-11199>`
- :ref:`Event ID 11201 <rsyslog-event-id-11201>`
