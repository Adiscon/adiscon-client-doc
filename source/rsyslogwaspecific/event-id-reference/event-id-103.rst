...
.. _rsyslog-event-id-103:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 103: The service control handler could not be installed.
   :event-id: 103
...
rsyslog Windows Agent Event ID 103: The service control handler could not be installed
======================================================================================
...
- **Message pattern:** The service control handler could not be installed. Additional detail: {event_detail}
