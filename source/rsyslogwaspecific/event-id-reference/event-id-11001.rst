...
.. _rsyslog-event-id-11001:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11001: SETP TLS session closed.
   :event-id: 11001
...
rsyslog Windows Agent Event ID 11001: SETP TLS session closed
=============================================================
...
- **Message pattern:** :spelling:ignore:`SETP sender TLS session was closed while waiting for a reply. Additional detail: {event_detail}`
