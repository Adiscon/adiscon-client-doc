...
.. _rsyslog-event-id-11126:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11126: SMTP listener: SMTP listener raised an exception.
   :event-id: 11126
...
rsyslog Windows Agent Event ID 11126: SMTP listener: SMTP listener raised an exception
======================================================================================

Answer
------

The smtp listener reported a warning condition. The event detail identifies the affected operation and carries the specific runtime reason.
