...
.. _rsyslog-event-id-11030:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11030: ODBC database action: database operation failed.
   :event-id: 11030
...
rsyslog Windows Agent Event ID 11030: ODBC database action: database operation failed
=====================================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11030 does not recur and that odbc database action processing continues.
...
- :ref:`Event ID 11010 <rsyslog-event-id-11010>`
- :ref:`Event ID 11011 <rsyslog-event-id-11011>`
- :ref:`Event ID 11029 <rsyslog-event-id-11029>`
