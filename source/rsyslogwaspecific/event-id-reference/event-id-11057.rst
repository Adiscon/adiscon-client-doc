...
.. _rsyslog-event-id-11057:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11057: Network and TLS transport: TLS server initialization failed.
   :event-id: 11057
...
rsyslog Windows Agent Event ID 11057: Network and TLS transport: TLS server initialization failed
=================================================================================================
