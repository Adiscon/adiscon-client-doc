...
.. _rsyslog-event-id-11180:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11180: Queue manager: disk queue cache operation failed.
   :event-id: 11180
...
rsyslog Windows Agent Event ID 11180: Queue manager: disk queue cache operation failed
======================================================================================
...
- **Message pattern:** Cquemanlist writeintoringbuffer.
...
Repeat or monitor the affected operation and confirm that Event ID 11180 does not recur and that queue manager processing continues.
