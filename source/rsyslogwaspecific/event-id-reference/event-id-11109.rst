...
.. _rsyslog-event-id-11109:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11109: Event Log Monitor service: Windows Event Log operation failed.
   :event-id: 11109
...
rsyslog Windows Agent Event ID 11109: Event Log Monitor service: Windows Event Log operation failed
===================================================================================================
