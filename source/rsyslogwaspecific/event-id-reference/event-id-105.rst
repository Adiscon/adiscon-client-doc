...
.. _rsyslog-event-id-105:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 105: The service was started.
   :event-id: 105
...
rsyslog Windows Agent Event ID 105: The service was started
===========================================================
...
- **Message pattern:** The service was started. Additional detail: {event_detail}
