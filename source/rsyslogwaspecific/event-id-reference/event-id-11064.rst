...
- **Message pattern:** :spelling:ignore:`CPU Monitor service: CPU monitor raised an exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11065 <rsyslog-event-id-11065>`
