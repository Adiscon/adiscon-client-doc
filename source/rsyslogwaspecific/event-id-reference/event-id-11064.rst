...
.. _rsyslog-event-id-11064:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11064: CPU Monitor service: CPU monitor raised an exception.
   :event-id: 11064
...
rsyslog Windows Agent Event ID 11064: CPU Monitor service: CPU monitor raised an exception
==========================================================================================
