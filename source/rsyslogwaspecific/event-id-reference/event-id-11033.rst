...
.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11033: Post Process action ignored an unsupported parse type.
   :event-id: 11033
...
rsyslog Windows Agent Event ID 11033: Post Process action ignored an unsupported parse type
===========================================================================================
