...
.. _rsyslog-event-id-11033:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11033: Action processing: runtime operation failed.
   :event-id: 11033
...
rsyslog Windows Agent Event ID 11033: Action processing: runtime operation failed
=================================================================================
...
- **Message pattern:** Cactionpostprocess parseandapply.
...
Repeat or monitor the affected operation and confirm that Event ID 11033 does not recur and that action processing processing continues.
