...
.. _rsyslog-event-id-11195:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11195: Disk queue: runtime data error.
   :event-id: 11195
...
rsyslog Windows Agent Event ID 11195: Disk queue: runtime data error
====================================================================
...
- :ref:`Event ID 11196 <rsyslog-event-id-11196>`
