...
.. _rsyslog-event-id-11047:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11047: Configuration: invalid host or IP address.
   :event-id: 11047
...
rsyslog Windows Agent Event ID 11047: Configuration: invalid host or IP address
===============================================================================
...
- **Message pattern:** Invalid hostname. Additional detail: {event_detail}
