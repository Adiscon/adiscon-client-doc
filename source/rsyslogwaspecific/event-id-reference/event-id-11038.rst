...
.. _rsyslog-event-id-11038:

.. meta::
   :description: Meaning and troubleshooting for rsyslog Windows Agent Event ID 11038: SNMP action: runtime operation failed.
   :event-id: 11038
...
rsyslog Windows Agent Event ID 11038: SNMP action: runtime operation failed
===========================================================================
...
- :ref:`Event ID 11016 <rsyslog-event-id-11016>`
