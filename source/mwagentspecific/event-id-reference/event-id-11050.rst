...
.. _mwagent-event-id-11050:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11050: Network and TLS transport: TLS operation warning.
   :event-id: 11050
...
MonitorWare Agent Event ID 11050: Network and TLS transport: TLS operation warning
==================================================================================
...
- **Message pattern:** Cwinsock initowncertandkey.
