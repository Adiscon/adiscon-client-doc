...
.. _mwagent-event-id-11227:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11227: Event rejected after shutdown intake closed.
   :event-id: 11227
...
MonitorWare Agent Event ID 11227: Event rejected after shutdown intake closed
=============================================================================
