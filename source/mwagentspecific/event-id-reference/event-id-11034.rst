...
.. _mwagent-event-id-11034:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11034: SETP sender: TLS client initialization failed.
   :event-id: 11034
...
MonitorWare Agent Event ID 11034: SETP sender: TLS client initialization failed
===============================================================================
