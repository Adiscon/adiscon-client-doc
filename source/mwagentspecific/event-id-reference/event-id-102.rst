...
.. _mwagent-event-id-102:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 102: The service could not be removed.
   :event-id: 102
...
MonitorWare Agent Event ID 102: The service could not be removed
================================================================
...
- **Message pattern:** The service could not be removed.
