...
.. _mwagent-event-id-106:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 106: The service received an unsupported control request.
   :event-id: 106
...
MonitorWare Agent Event ID 106: The service received an unsupported control request
===================================================================================
