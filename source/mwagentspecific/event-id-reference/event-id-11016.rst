...
.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11016: An SNMP trap variable contains an invalid OID.
   :event-id: 11016
...
MonitorWare Agent Event ID 11016: An SNMP trap variable contains an invalid OID
===============================================================================
...
- :ref:`Event ID 11038 <mwagent-event-id-11038>`
