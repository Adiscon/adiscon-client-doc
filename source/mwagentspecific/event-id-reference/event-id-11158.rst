...
.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11158: Empty log-rotation queue file could not be deleted.
   :event-id: 11158
...
MonitorWare Agent Event ID 11158: Empty log-rotation queue file could not be deleted
====================================================================================
