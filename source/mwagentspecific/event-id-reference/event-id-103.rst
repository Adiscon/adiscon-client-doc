...
.. _mwagent-event-id-103:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 103: The service control handler could not be installed.
   :event-id: 103
...
MonitorWare Agent Event ID 103: The service control handler could not be installed
==================================================================================
