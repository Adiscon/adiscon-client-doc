...
.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11202: TCP listener could not assign an accepted socket.
   :event-id: 11202
...
MonitorWare Agent Event ID 11202: TCP listener could not assign an accepted socket
==================================================================================
