...
.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11054: TLS certificate-name authentication has no permitted peers.
   :event-id: 11054
...
MonitorWare Agent Event ID 11054: TLS certificate-name authentication has no permitted peers
============================================================================================
...
- :ref:`Event ID 11056 <mwagent-event-id-11056>`
