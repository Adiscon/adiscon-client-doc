...
.. _mwagent-event-id-11179:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11179: Queue manager: disk queue cache operation failed.
   :event-id: 11179
...
MonitorWare Agent Event ID 11179: Queue manager: disk queue cache operation failed
==================================================================================
