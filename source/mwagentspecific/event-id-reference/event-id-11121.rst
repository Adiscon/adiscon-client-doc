...
.. _mwagent-event-id-11121:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11121: RELP listener: listener could not bind to its configured address.
   :event-id: 11121
...
MonitorWare Agent Event ID 11121: RELP listener: listener could not bind to its configured address
==================================================================================================
...
- :ref:`Event ID 11122 <mwagent-event-id-11122>`
