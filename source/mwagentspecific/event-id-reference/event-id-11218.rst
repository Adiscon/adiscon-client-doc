...
.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11218: Control Windows Service action could not stop the target service.
   :event-id: 11218
...
MonitorWare Agent Event ID 11218: Control Windows Service action could not stop the target service
==================================================================================================
