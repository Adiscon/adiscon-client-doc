...
.. _mwagent-event-id-11023:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11023: Action processing: invalid action type in configuration.
   :event-id: 11023
...
MonitorWare Agent Event ID 11023: Action processing: invalid action type in configuration
=========================================================================================
...
- **Message pattern:** :spelling:ignore:`Action processing: invalid action type in configuration. Additional detail: {event_detail}`
