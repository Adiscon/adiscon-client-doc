...
.. _mwagent-event-id-11090:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11090: SETP listener stopped after a protocol server error.
   :event-id: 11090
...
MonitorWare Agent Event ID 11090: SETP listener stopped after a protocol server error
=====================================================================================
...
- :ref:`Event ID 11093 <mwagent-event-id-11093>`
