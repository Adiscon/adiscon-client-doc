...
.. _mwagent-event-id-11156:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11156: Rotated log could not be moved to its archive destination.
   :event-id: 11156
...
MonitorWare Agent Event ID 11156: Rotated log could not be moved to its archive destination
===========================================================================================
