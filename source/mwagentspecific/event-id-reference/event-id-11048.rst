...
.. _mwagent-event-id-11048:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11048: Network and TLS transport: unknown runtime error.
   :event-id: 11048
...
MonitorWare Agent Event ID 11048: Network and TLS transport: unknown runtime error
==================================================================================
