...
.. _mwagent-event-id-11032:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11032: OLE DB action: OLE DB operation failed.
   :event-id: 11032
...
MonitorWare Agent Event ID 11032: OLE DB action: OLE DB operation failed
========================================================================
