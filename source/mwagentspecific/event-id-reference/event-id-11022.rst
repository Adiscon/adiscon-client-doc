...
.. _mwagent-event-id-11022:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11022: Action processing: action type is missing from configuration.
   :event-id: 11022
...
MonitorWare Agent Event ID 11022: Action processing: action type is missing from configuration
==============================================================================================
