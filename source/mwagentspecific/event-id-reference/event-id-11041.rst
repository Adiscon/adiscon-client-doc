...
.. _mwagent-event-id-11041:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11041: Start Program action received an unexpected wait result.
   :event-id: 11041
...
MonitorWare Agent Event ID 11041: Start Program action received an unexpected wait result
=========================================================================================
