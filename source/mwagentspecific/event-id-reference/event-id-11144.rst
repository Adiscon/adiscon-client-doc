...
.. _mwagent-event-id-11144:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11144: Syslog listener: listener could not bind to its configured address.
   :event-id: 11144
...
MonitorWare Agent Event ID 11144: Syslog listener: listener could not bind to its configured address
====================================================================================================
