...
.. _mwagent-event-id-11180:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11180: Queue manager: disk queue cache operation failed.
   :event-id: 11180
...
MonitorWare Agent Event ID 11180: Queue manager: disk queue cache operation failed
==================================================================================
