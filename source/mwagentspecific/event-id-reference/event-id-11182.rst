...
.. _mwagent-event-id-11182:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11182: Queue manager: disk queue cache operation failed.
   :event-id: 11182
...
MonitorWare Agent Event ID 11182: Queue manager: disk queue cache operation failed
==================================================================================
