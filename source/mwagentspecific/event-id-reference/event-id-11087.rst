...
.. _mwagent-event-id-11087:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11087: HTTP Probe service: probe operation raised an unknown exception.
   :event-id: 11087
...
MonitorWare Agent Event ID 11087: HTTP Probe service: probe operation raised an unknown exception
=================================================================================================

Answer
------

The http probe service reported an error condition. The event detail identifies the affected operation and carries the specific runtime reason.
...
- **Message pattern:** Cinfosourcehttpprobe.
...
- :doc:`Event ID 11086 <event-id-11086>`
