...
.. _mwagent-event-id-11064:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11064: CPU Monitor service: CPU monitor raised an exception.
   :event-id: 11064
...
MonitorWare Agent Event ID 11064: CPU Monitor service: CPU monitor raised an exception
======================================================================================
