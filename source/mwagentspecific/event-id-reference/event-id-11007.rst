...
.. _mwagent-event-id-11007:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11007: Action configuration: required timer could not be created.
   :event-id: 11007
...
MonitorWare Agent Event ID 11007: Action configuration: required timer could not be created
===========================================================================================

Answer
------

Action configuration: required timer could not be created. The product recorded this while processing action configuration; the appended event detail identifies the affected object, operation, or provider error.
...
- :ref:`Event ID 11008 <mwagent-event-id-11008>`
- :ref:`Event ID 11009 <mwagent-event-id-11009>`
