...
.. _mwagent-event-id-11157:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11157: Existing archive could not be renamed to prevent overwrite.
   :event-id: 11157
...
MonitorWare Agent Event ID 11157: Existing archive could not be renamed to prevent overwrite
============================================================================================
