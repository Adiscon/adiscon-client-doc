...
.. _mwagent-event-id-11073:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11073: DTLS listener: runtime operation failed.
   :event-id: 11073
...
MonitorWare Agent Event ID 11073: DTLS listener: runtime operation failed
=========================================================================

Answer
------

DTLS listener: runtime operation failed. The product recorded this while processing dtls listener; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`DTLS listener: runtime operation failed. Additional detail: {event_detail}`
...
- :ref:`Event ID 11072 <mwagent-event-id-11072>`
