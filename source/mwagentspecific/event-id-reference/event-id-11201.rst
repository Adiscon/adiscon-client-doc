...
.. _mwagent-event-id-11201:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11201: TCP and TLS listener: TCP listener fatal error.
   :event-id: 11201
...
MonitorWare Agent Event ID 11201: TCP and TLS listener: TCP listener fatal error
================================================================================
