...
.. _mwagent-event-id-11200:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11200: TCP and TLS listener: TCP listener fatal error.
   :event-id: 11200
...
MonitorWare Agent Event ID 11200: TCP and TLS listener: TCP listener fatal error
================================================================================
