...
.. _mwagent-event-id-11217:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11217: Control Windows Service action could not start the target service.
   :event-id: 11217
...
MonitorWare Agent Event ID 11217: Control Windows Service action could not start the target service
===================================================================================================
