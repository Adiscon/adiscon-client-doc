...
.. _mwagent-event-id-11164:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11164: Email action: invalid SMTP recipient address.
   :event-id: 11164
...
MonitorWare Agent Event ID 11164: Email action: invalid SMTP recipient address
==============================================================================
...
- :ref:`Event ID 11165 <mwagent-event-id-11165>`
