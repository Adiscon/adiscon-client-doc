...
.. _mwagent-event-id-11198:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11198: TCP and TLS listener: TCP listener fatal error.
   :event-id: 11198
...
MonitorWare Agent Event ID 11198: TCP and TLS listener: TCP listener fatal error
================================================================================
