...
.. _mwagent-event-id-11226:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11226: SNMP listener shutdown wake fallback.
   :event-id: 11226
...
MonitorWare Agent Event ID 11226: SNMP listener shutdown wake fallback
======================================================================
