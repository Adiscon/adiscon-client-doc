...
.. _mwagent-event-id-11229:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11229: Message Ringbuffer action is not registered.
   :event-id: 11229
...
MonitorWare Agent Event ID 11229: Message Ringbuffer action is not registered
=============================================================================
