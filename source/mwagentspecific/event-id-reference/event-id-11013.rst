...
.. _mwagent-event-id-11013:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11013: OLE DB action: OLE DB operation failed.
   :event-id: 11013
...
MonitorWare Agent Event ID 11013: OLE DB action: OLE DB operation failed
========================================================================
...
- :ref:`Event ID 11012 <mwagent-event-id-11012>`
