...
.. _mwagent-event-id-11042:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11042: Write to File action has an invalid output format.
   :event-id: 11042
...
MonitorWare Agent Event ID 11042: Write to File action has an invalid output format
===================================================================================
