...
.. _mwagent-event-id-11225:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11225: RELP listener shutdown wake fallback.
   :event-id: 11225
...
MonitorWare Agent Event ID 11225: RELP listener shutdown wake fallback
======================================================================
