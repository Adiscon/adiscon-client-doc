...
.. _mwagent-event-id-11057:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11057: Network and TLS transport: TLS server initialization failed.
   :event-id: 11057
...
MonitorWare Agent Event ID 11057: Network and TLS transport: TLS server initialization failed
=============================================================================================
...
- :ref:`Event ID 11048 <mwagent-event-id-11048>`
