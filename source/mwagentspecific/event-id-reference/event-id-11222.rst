...
.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11222: Consumed log-rotation queue file could not be deleted.
   :event-id: 11222
...
MonitorWare Agent Event ID 11222: Consumed log-rotation queue file could not be deleted
=======================================================================================
