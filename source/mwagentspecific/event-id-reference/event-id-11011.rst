...
.. _mwagent-event-id-11011:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11011: ODBC database action: database operation failed.
   :event-id: 11011
...
MonitorWare Agent Event ID 11011: ODBC database action: database operation failed
=================================================================================
