...
.. _mwagent-event-id-11139:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11139: SNMP Trap Receiver: SNMP operation raised an exception.
   :event-id: 11139
...
MonitorWare Agent Event ID 11139: SNMP Trap Receiver: SNMP operation raised an exception
========================================================================================
