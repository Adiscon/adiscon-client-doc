...
.. _mwagent-event-id-11089:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11089: IMAP Probe service: probe operation raised an unknown exception.
   :event-id: 11089
...
MonitorWare Agent Event ID 11089: IMAP Probe service: probe operation raised an unknown exception
=================================================================================================
...
- **Message pattern:** :spelling:ignore:`IMAP Probe service: probe operation raised an unknown exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11088 <mwagent-event-id-11088>`
