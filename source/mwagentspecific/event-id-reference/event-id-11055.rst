...
.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11055: TLS client certificate fingerprint could not be computed.
   :event-id: 11055
...
MonitorWare Agent Event ID 11055: TLS client certificate fingerprint could not be computed
==========================================================================================
