...
.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11187: A configured input service type is not recognized.
   :event-id: 11187
...
MonitorWare Agent Event ID 11187: A configured input service type is not recognized
===================================================================================
