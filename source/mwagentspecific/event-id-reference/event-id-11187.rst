...
.. _mwagent-event-id-11187:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11187: Service configuration: runtime operation failed.
   :event-id: 11187
...
MonitorWare Agent Event ID 11187: Service configuration: runtime operation failed
=================================================================================
...
- **Message pattern:** Servicemanager unknown service type.
