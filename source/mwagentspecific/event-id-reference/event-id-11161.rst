...
.. _mwagent-event-id-11161:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11161: Configuration reload kept the existing log-rotation workers.
   :event-id: 11161
...
MonitorWare Agent Event ID 11161: Configuration reload kept the existing log-rotation workers
=============================================================================================
