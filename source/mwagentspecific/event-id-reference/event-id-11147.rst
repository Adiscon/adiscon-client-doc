...
.. _mwagent-event-id-11147:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11147: Event Log Monitor V2 service: required timer could not be created.
   :event-id: 11147
...
MonitorWare Agent Event ID 11147: Event Log Monitor V2 service: required timer could not be created
===================================================================================================
...
- **Message pattern:** :spelling:ignore:`Wevthelper wevthelper. Additional detail: {event_detail}`
