...
.. _mwagent-event-id-11181:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11181: Queue manager: disk queue cache operation failed.
   :event-id: 11181
...
MonitorWare Agent Event ID 11181: Queue manager: disk queue cache operation failed
==================================================================================
...
- **Message pattern:** Cquemanlist movetonextitem.
