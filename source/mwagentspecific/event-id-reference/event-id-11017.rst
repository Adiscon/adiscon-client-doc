...
.. _mwagent-event-id-11017:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11017: Forward Syslog action: action initialization failed.
   :event-id: 11017
...
MonitorWare Agent Event ID 11017: Forward Syslog action: action initialization failed
=====================================================================================
...
- **Message pattern:** :spelling:ignore:`Forward Syslog action: action initialization failed. Additional detail: {event_detail}`
...
- :ref:`Event ID 11040 <mwagent-event-id-11040>`
