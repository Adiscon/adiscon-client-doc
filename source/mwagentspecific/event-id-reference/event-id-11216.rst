...
.. _mwagent-event-id-11216:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11216: Control Windows Service action could not open the target service.
   :event-id: 11216
...
MonitorWare Agent Event ID 11216: Control Windows Service action could not open the target service
==================================================================================================
