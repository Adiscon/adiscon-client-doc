...
.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11216: Control Windows Service action: runtime operation failed.
   :event-id: 11216
...
MonitorWare Agent Event ID 11216: Control Windows Service action: runtime operation failed
==========================================================================================
...
- **Message pattern:** Cactioncontrolntservice open service handle.
