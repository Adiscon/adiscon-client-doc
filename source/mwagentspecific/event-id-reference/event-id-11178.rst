...
.. _mwagent-event-id-11178:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11178: Queue manager: disk queue cache operation failed.
   :event-id: 11178
...
MonitorWare Agent Event ID 11178: Queue manager: disk queue cache operation failed
==================================================================================
