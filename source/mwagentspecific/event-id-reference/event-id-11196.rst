...
.. _mwagent-event-id-11196:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11196: Disk queue: runtime data error.
   :event-id: 11196
...
MonitorWare Agent Event ID 11196: Disk queue: runtime data error
================================================================
...
- :ref:`Event ID 11197 <mwagent-event-id-11197>`
