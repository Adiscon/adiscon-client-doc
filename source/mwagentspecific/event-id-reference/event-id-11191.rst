...
.. _mwagent-event-id-11191:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11191: Service configuration: log rotation is not licensed.
   :event-id: 11191
...
MonitorWare Agent Event ID 11191: Service configuration: log rotation is not licensed
=====================================================================================
...
- **Message pattern:** This license does not include the logrotation feature. Additional detail: {event_detail}
