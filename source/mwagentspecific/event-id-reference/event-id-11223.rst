...
.. _mwagent-event-id-11223:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11223: Protected service shutdown deadline expired.
   :event-id: 11223
...
MonitorWare Agent Event ID 11223: Protected service shutdown deadline expired
=============================================================================
...
- :ref:`Event ID 11227 <mwagent-event-id-11227>`
