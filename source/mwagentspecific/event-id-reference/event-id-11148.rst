...
The event log monitor v2 service reported an error condition. The event detail identifies the affected operation and carries the specific runtime reason.
...
- **Message pattern:** Wevthelper checkbookmark.
