...
.. _mwagent-event-id-11072:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11072: DTLS listener: listener could not bind to its configured address.
   :event-id: 11072
...
MonitorWare Agent Event ID 11072: DTLS listener: listener could not bind to its configured address
==================================================================================================
...
- :ref:`Event ID 11073 <mwagent-event-id-11073>`
