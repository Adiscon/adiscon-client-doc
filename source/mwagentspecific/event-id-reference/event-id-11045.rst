...
.. _mwagent-event-id-11045:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11045: File-based configuration: file-based configuration could not be loaded.
   :event-id: 11045
...
MonitorWare Agent Event ID 11045: File-based configuration: file-based configuration could not be loaded
========================================================================================================
...
- :ref:`Event ID 11046 <mwagent-event-id-11046>`
