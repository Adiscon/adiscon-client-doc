...
.. _mwagent-event-id-11145:

.. meta::
   :description: Meaning and troubleshooting for MonitorWare Agent Event ID 11145: Syslog listener: listener could not bind to its configured address.
   :event-id: 11145
...
MonitorWare Agent Event ID 11145: Syslog listener: listener could not bind to its configured address
====================================================================================================
