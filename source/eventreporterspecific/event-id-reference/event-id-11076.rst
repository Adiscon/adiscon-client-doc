...
.. _eventreporter-event-id-11076:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11076: File Monitor service: configured file could not be opened.
   :event-id: 11076
...
EventReporter Event ID 11076: File Monitor service: configured file could not be opened
=======================================================================================
...
- **Message pattern:** :spelling:ignore:`Filemonitor access to file denied. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11076 does not recur and that file monitor service processing continues.
...
- :ref:`Event ID 11074 <eventreporter-event-id-11074>`
