...
.. _eventreporter-event-id-11090:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11090: SETP listener stopped after a protocol server error.
   :event-id: 11090
...
EventReporter Event ID 11090: SETP listener stopped after a protocol server error
=================================================================================
...
- :ref:`Event ID 11093 <eventreporter-event-id-11093>`
