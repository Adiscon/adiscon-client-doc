...
.. _eventreporter-event-id-11161:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11161: Configuration reload kept the existing log-rotation workers.
   :event-id: 11161
...
EventReporter Event ID 11161: Configuration reload kept the existing log-rotation workers
=========================================================================================
