...
.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11219: Control Windows Service action could not pause the target service.
   :event-id: 11219
...
EventReporter Event ID 11219: Control Windows Service action could not pause the target service
===============================================================================================
