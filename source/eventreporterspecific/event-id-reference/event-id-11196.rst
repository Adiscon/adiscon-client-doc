...
.. _eventreporter-event-id-11196:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11196: Disk queue: runtime data error.
   :event-id: 11196
...
EventReporter Event ID 11196: Disk queue: runtime data error
============================================================
