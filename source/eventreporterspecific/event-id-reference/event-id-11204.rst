...
Product service: invalid worker-thread count was corrected. The product recorded this while processing product service; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`Loadstate. Additional detail: {event_detail}`
