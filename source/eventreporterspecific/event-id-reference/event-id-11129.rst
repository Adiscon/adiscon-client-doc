...
.. _eventreporter-event-id-11129:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11129: SMTP listener: SMTP listener raised an unknown exception.
   :event-id: 11129
...
EventReporter Event ID 11129: SMTP listener: SMTP listener raised an unknown exception
======================================================================================

Answer
------

SMTP listener: SMTP listener raised an unknown exception. The product recorded this while processing smtp listener; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11129 does not recur and that smtp listener processing continues.
...
- :ref:`Event ID 11126 <eventreporter-event-id-11126>`
- :ref:`Event ID 11127 <eventreporter-event-id-11127>`
- :ref:`Event ID 11128 <eventreporter-event-id-11128>`
