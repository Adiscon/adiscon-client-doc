...
.. _eventreporter-event-id-11104:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11104: Event Log Monitor service: Windows Event Log could not be cleared.
   :event-id: 11104
...
EventReporter Event ID 11104: Event Log Monitor service: Windows Event Log could not be cleared
===============================================================================================

Answer
------

Event Log Monitor service: Windows Event Log could not be cleared. The product recorded this while processing event log monitor service; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`Event Log Monitor service: Windows Event Log could not be cleared. Additional detail: {event_detail}`
