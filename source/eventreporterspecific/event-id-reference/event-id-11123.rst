...
.. _eventreporter-event-id-11123:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11123: Serial Port Monitor: serial port operation failed.
   :event-id: 11123
...
EventReporter Event ID 11123: Serial Port Monitor: serial port operation failed
===============================================================================
...
- **Message pattern:** :spelling:ignore:`Serial Port Monitor: serial port operation failed. Additional detail: {event_detail}`
