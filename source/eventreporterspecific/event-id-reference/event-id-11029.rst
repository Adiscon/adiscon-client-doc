...
.. _eventreporter-event-id-11029:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11029: ODBC database action: database operation failed.
   :event-id: 11029
...
EventReporter Event ID 11029: ODBC database action: database operation failed
=============================================================================
