...
.. _eventreporter-event-id-11119:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11119: POP3 Probe service: probe operation raised an exception.
   :event-id: 11119
...
EventReporter Event ID 11119: POP3 Probe service: probe operation raised an exception
=====================================================================================
...
- **Message pattern:** :spelling:ignore:`POP3 Probe service: probe operation raised an exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11120 <eventreporter-event-id-11120>`
