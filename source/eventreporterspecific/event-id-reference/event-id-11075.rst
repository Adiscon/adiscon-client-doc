...
.. _eventreporter-event-id-11075:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11075: File Monitor service: configured file could not be opened.
   :event-id: 11075
...
EventReporter Event ID 11075: File Monitor service: configured file could not be opened
=======================================================================================
...
- **Message pattern:** :spelling:ignore:`Filemonitor file path not found. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11075 does not recur and that file monitor service processing continues.
