...
.. _eventreporter-event-id-11049:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11049: Network and TLS transport: TLS operation warning.
   :event-id: 11049
...
EventReporter Event ID 11049: Network and TLS transport: TLS operation warning
==============================================================================
...
- **Message pattern:** Cwinsock initcacertificate.
