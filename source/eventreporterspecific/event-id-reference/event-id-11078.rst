...
.. _eventreporter-event-id-11078:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11078: File Monitor service: file monitoring operation failed.
   :event-id: 11078
...
EventReporter Event ID 11078: File Monitor service: file monitoring operation failed
====================================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11078 does not recur and that file monitor service processing continues.
