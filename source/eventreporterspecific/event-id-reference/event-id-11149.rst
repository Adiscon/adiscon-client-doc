...
.. _eventreporter-event-id-11149:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11149: Event Log Monitor V2 service: general runtime error.
   :event-id: 11149
...
EventReporter Event ID 11149: Event Log Monitor V2 service: general runtime error
=================================================================================

Answer
------

Event Log Monitor V2 service: general runtime error. The product recorded this while processing event log monitor v2 service; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`Event Log Monitor V2 service: general runtime error. Additional detail: {event_detail}`
...
- :ref:`Event ID 11148 <eventreporter-event-id-11148>`
