...
.. _eventreporter-event-id-11108:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11108: Event Log Monitor service: Windows Event Log operation failed.
   :event-id: 11108
...
EventReporter Event ID 11108: Event Log Monitor service: Windows Event Log operation failed
===========================================================================================
...
- **Message pattern:** :spelling:ignore:`Event Log Monitor service: Windows Event Log operation failed. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11108 does not recur and that event log monitor service processing continues.
