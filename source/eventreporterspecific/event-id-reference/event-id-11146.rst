...
.. _eventreporter-event-id-11146:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11146: Syslog listener: runtime operation failed.
   :event-id: 11146
...
EventReporter Event ID 11146: Syslog listener: runtime operation failed
=======================================================================
...
- **Message pattern:** Syslog listener: runtime operation failed. Additional detail: {event_detail}
