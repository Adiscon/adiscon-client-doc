...
.. _eventreporter-event-id-11115:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11115: Syslog listener: listener could not bind to its configured address.
   :event-id: 11115
...
EventReporter Event ID 11115: Syslog listener: listener could not bind to its configured address
================================================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11115 does not recur and that syslog listener processing continues.
