...
.. _eventreporter-event-id-11125:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11125: Serial Port Monitor: serial port operation raised an unknown exception.
   :event-id: 11125
...
EventReporter Event ID 11125: Serial Port Monitor: serial port operation raised an unknown exception
====================================================================================================

Answer
------

Serial Port Monitor: serial port operation raised an unknown exception. The product recorded this while processing serial port monitor; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11125 does not recur and that serial port monitor processing continues.
...
- :ref:`Event ID 11123 <eventreporter-event-id-11123>`
- :ref:`Event ID 11124 <eventreporter-event-id-11124>`
