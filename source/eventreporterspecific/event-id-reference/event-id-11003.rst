...
.. _eventreporter-event-id-11003:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11003: SETP delivery failed.
   :event-id: 11003
...
EventReporter Event ID 11003: SETP delivery failed
==================================================

Answer
------

The action failed for this message because action caching is not active.
...
- **Message pattern:** :spelling:ignore:`SETP sender could not complete the send operation. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11003 does not recur and that setp sender processing continues.
