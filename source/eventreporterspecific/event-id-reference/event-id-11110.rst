...
.. _eventreporter-event-id-11110:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11110: Event Log Monitor service: licensed Event Log Monitor limit reached.
   :event-id: 11110
...
EventReporter Event ID 11110: Event Log Monitor service: licensed Event Log Monitor limit reached
=================================================================================================

Answer
------

Event Log Monitor service: licensed Event Log Monitor limit reached. The product recorded this while processing event log monitor service; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`Event Log Monitor service: licensed Event Log Monitor limit reached. Additional detail: {event_detail}`
