...
.. _eventreporter-event-id-11150:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11150: Event Log Monitor V2 service: Windows Event Log operation failed.
   :event-id: 11150
...
EventReporter Event ID 11150: Event Log Monitor V2 service: Windows Event Log operation failed
==============================================================================================
...
- **Message pattern:** :spelling:ignore:`Event Log Monitor V2 service: Windows Event Log operation failed. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11150 does not recur and that event log monitor v2 service processing continues.
