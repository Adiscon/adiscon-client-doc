...
.. _eventreporter-event-id-11034:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11034: SETP sender: TLS client initialization failed.
   :event-id: 11034
...
EventReporter Event ID 11034: SETP sender: TLS client initialization failed
===========================================================================

Answer
------

SETP sender: TLS client initialization failed. The product recorded this while processing setp sender; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`SETP sender: TLS client initialization failed. Additional detail: {event_detail}`
