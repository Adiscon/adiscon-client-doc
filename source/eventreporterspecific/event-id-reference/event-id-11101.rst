...
.. _eventreporter-event-id-11101:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11101: Event reporter service.
   :event-id: 11101
...
EventReporter Event ID 11101: Event reporter service
====================================================

Answer
------

Event reporter service. The product recorded this while processing event log monitor service; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`Event reporter service. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11101 does not recur and that event log monitor service processing continues.
