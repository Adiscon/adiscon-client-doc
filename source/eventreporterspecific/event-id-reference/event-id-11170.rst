...
.. _eventreporter-event-id-11170:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11170: Queue manager: runtime operation failed.
   :event-id: 11170
...
EventReporter Event ID 11170: Queue manager: runtime operation failed
=====================================================================
...
- **Message pattern:** Queue manager: runtime operation failed. Additional detail: {event_detail}
...
Repeat or monitor the affected operation and confirm that Event ID 11170 does not recur and that queue manager processing continues.
...
- :ref:`Event ID 11173 <eventreporter-event-id-11173>`
