...
.. _eventreporter-event-id-11213:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11213: System exception while compiling an NT Event Log category.
   :event-id: 11213
...
EventReporter Event ID 11213: System exception while compiling an NT Event Log category
=======================================================================================
...
- **Message pattern:** :spelling:ignore:`System exception while compiling an NT Event Log category. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11213 does not recur and that event log monitor service processing continues.
