...
.. _eventreporter-event-id-11035:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11035: SETP sender: SETP session initialization failed.
   :event-id: 11035
...
EventReporter Event ID 11035: SETP sender: SETP session initialization failed
=============================================================================

Answer
------

SETP sender: SETP session initialization failed. The product recorded this while processing setp sender; the appended event detail identifies the affected object, operation, or provider error.
...
Repeat or monitor the affected operation and confirm that Event ID 11035 does not recur and that setp sender processing continues.
...
- :ref:`Event ID 11000 <eventreporter-event-id-11000>`
- :ref:`Event ID 11001 <eventreporter-event-id-11001>`
- :ref:`Event ID 11002 <eventreporter-event-id-11002>`
