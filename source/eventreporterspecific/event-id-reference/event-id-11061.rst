...
.. _eventreporter-event-id-11061:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11061: MonitorWare Echo service: MonitorWare Echo operation raised an exception.
   :event-id: 11061
...
EventReporter Event ID 11061: MonitorWare Echo service: MonitorWare Echo operation raised an exception
======================================================================================================
...
- **Message pattern:** :spelling:ignore:`MonitorWare Echo service: MonitorWare Echo operation raised an exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11063 <eventreporter-event-id-11063>`
