...
.. _eventreporter-event-id-11198:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11198: TCP and TLS listener: TCP listener fatal error.
   :event-id: 11198
...
EventReporter Event ID 11198: TCP and TLS listener: TCP listener fatal error
============================================================================
