...
.. _eventreporter-event-id-11000:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11000: SETP connection closed by the receiver.
   :event-id: 11000
...
EventReporter Event ID 11000: SETP connection closed by the receiver
====================================================================
...
- **Message pattern:** :spelling:ignore:`SETP sender connection was closed by the remote side while waiting for a reply. Additional detail: {event_detail}`
