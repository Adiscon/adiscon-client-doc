...
.. _eventreporter-event-id-11077:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11077: File Monitor service: file monitoring operation failed.
   :event-id: 11077
...
EventReporter Event ID 11077: File Monitor service: file monitoring operation failed
====================================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11077 does not recur and that file monitor service processing continues.
