...
.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11221: Target service did not reach the requested state before timeout.
   :event-id: 11221
...
EventReporter Event ID 11221: Target service did not reach the requested state before timeout
=============================================================================================
