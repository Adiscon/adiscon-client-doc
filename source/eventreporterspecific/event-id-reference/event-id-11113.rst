...
.. _eventreporter-event-id-11113:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11113: Syslog listener: service component initialization failed.
   :event-id: 11113
...
EventReporter Event ID 11113: Syslog listener: service component initialization failed
======================================================================================
...
- **Message pattern:** :spelling:ignore:`Syslog listener: service component initialization failed. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11113 does not recur and that syslog listener processing continues.
...
- :ref:`Event ID 11115 <eventreporter-event-id-11115>`
