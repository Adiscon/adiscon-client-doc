...
.. _eventreporter-event-id-11124:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11124: Serial Port Monitor: serial port operation raised an exception.
   :event-id: 11124
...
EventReporter Event ID 11124: Serial Port Monitor: serial port operation raised an exception
============================================================================================

Answer
------

Serial Port Monitor: serial port operation raised an exception. The product recorded this while processing serial port monitor; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`Serial Port Monitor: serial port operation raised an exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11125 <eventreporter-event-id-11125>`
