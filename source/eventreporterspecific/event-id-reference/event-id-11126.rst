...
.. _eventreporter-event-id-11126:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11126: SMTP listener: SMTP listener raised an exception.
   :event-id: 11126
...
EventReporter Event ID 11126: SMTP listener: SMTP listener raised an exception
==============================================================================
...
- **Message pattern:** SMTP listener: SMTP listener raised an exception. Additional detail: {event_detail}
...
Repeat or monitor the affected operation and confirm that Event ID 11126 does not recur and that smtp listener processing continues.
...
- :ref:`Event ID 11129 <eventreporter-event-id-11129>`
