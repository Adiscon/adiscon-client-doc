...
.. _eventreporter-event-id-11098:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11098: Event Log Monitor service: Windows Event Log could not be opened.
   :event-id: 11098
...
EventReporter Event ID 11098: Event Log Monitor service: Windows Event Log could not be opened
==============================================================================================

Answer
------

Event Log Monitor service: Windows Event Log could not be opened. The product recorded this while processing event log monitor service; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`Event Log Monitor service: Windows Event Log could not be opened. Additional detail: {event_detail}`
