...
.. _eventreporter-event-id-11133:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11133: SNMP Monitor service: SNMP operation raised an exception.
   :event-id: 11133
...
EventReporter Event ID 11133: SNMP Monitor service: SNMP operation raised an exception
======================================================================================
...
- **Message pattern:** :spelling:ignore:`SNMP Monitor service: SNMP operation raised an exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11135 <eventreporter-event-id-11135>`
