...
.. _eventreporter-event-id-11002:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11002: SETP delivery delayed in the action cache.
   :event-id: 11002
...
EventReporter Event ID 11002: SETP delivery delayed in the action cache
=======================================================================
...
- **Message pattern:** :spelling:ignore:`SETP sender could not complete the send operation; the message was moved to the action cache for retry. Additional detail: {event_detail}`
...
- :ref:`Event ID 11003 <eventreporter-event-id-11003>`
