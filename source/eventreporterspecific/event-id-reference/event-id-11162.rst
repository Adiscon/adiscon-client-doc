...
.. _eventreporter-event-id-11162:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11162: Log-rotation jobs cannot be persisted because the data directory is unset.
   :event-id: 11162
...
EventReporter Event ID 11162: Log-rotation jobs cannot be persisted because the data directory is unset
=======================================================================================================
