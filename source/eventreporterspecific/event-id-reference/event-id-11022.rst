...
.. _eventreporter-event-id-11022:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11022: Action processing: action type is missing from configuration.
   :event-id: 11022
...
EventReporter Event ID 11022: Action processing: action type is missing from configuration
==========================================================================================
