...
.. _eventreporter-event-id-11199:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11199: TCP and TLS listener: TLS server initialization failed.
   :event-id: 11199
...
EventReporter Event ID 11199: TCP and TLS listener: TLS server initialization failed
====================================================================================
