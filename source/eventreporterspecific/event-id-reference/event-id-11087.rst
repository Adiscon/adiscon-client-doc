...
- **Message pattern:** :spelling:ignore:`HTTP Probe service: probe operation raised an unknown exception. Additional detail: {event_detail}`
...
- :ref:`Event ID 11086 <eventreporter-event-id-11086>`
