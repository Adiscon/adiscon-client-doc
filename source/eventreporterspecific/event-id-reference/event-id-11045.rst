...
.. _eventreporter-event-id-11045:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11045: File-based configuration: file-based configuration could not be loaded.
   :event-id: 11045
...
EventReporter Event ID 11045: File-based configuration: file-based configuration could not be loaded
====================================================================================================
...
- :ref:`Event ID 11046 <eventreporter-event-id-11046>`
