...
.. _eventreporter-event-id-11051:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11051: Network and TLS transport: TLS operation warning.
   :event-id: 11051
...
EventReporter Event ID 11051: Network and TLS transport: TLS operation warning
==============================================================================
...
- **Message pattern:** Cwinsock initopensslserversession client ssl certificate verification.
