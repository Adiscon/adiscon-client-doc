...
.. _eventreporter-event-id-11080:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11080: File Monitor service: configured file could not be opened.
   :event-id: 11080
...
EventReporter Event ID 11080: File Monitor service: configured file could not be opened
=======================================================================================
...
- **Message pattern:** :spelling:ignore:`Filemonitor filesyntaxwrong. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11080 does not recur and that file monitor service processing continues.
