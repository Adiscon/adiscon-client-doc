...
.. _eventreporter-event-id-11079:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11079: File Monitor service: configured file could not be opened.
   :event-id: 11079
...
EventReporter Event ID 11079: File Monitor service: configured file could not be opened
=======================================================================================
...
- **Message pattern:** :spelling:ignore:`Filemonitor filenotfound or pathnotfound. Additional detail: {event_detail}`
