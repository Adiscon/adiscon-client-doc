...
.. _eventreporter-event-id-11046:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11046: File-based configuration: file-based configuration could not be loaded.
   :event-id: 11046
...
EventReporter Event ID 11046: File-based configuration: file-based configuration could not be loaded
====================================================================================================
...
- :ref:`Event ID 11045 <eventreporter-event-id-11045>`
