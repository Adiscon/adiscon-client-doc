...
.. _eventreporter-event-id-11016:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11016: An SNMP trap variable contains an invalid OID.
   :event-id: 11016
...
EventReporter Event ID 11016: An SNMP trap variable contains an invalid OID
===========================================================================
...
- :ref:`Event ID 11038 <eventreporter-event-id-11038>`
