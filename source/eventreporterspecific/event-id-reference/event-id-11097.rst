...
.. _eventreporter-event-id-11097:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11097: Event Log Monitor service: Windows Event Log operation failed.
   :event-id: 11097
...
EventReporter Event ID 11097: Event Log Monitor service: Windows Event Log operation failed
===========================================================================================
...
Repeat or monitor the affected operation and confirm that Event ID 11097 does not recur and that event log monitor service processing continues.
