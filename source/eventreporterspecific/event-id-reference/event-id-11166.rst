...
.. _eventreporter-event-id-11166:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11166: OLE DB action: OLE DB operation failed.
   :event-id: 11166
...
EventReporter Event ID 11166: OLE DB action: OLE DB operation failed
====================================================================
