...
.. _eventreporter-event-id-11094:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11094: SETP receiver: SETP operation raised an unknown exception.
   :event-id: 11094
...
EventReporter Event ID 11094: SETP receiver: SETP operation raised an unknown exception
=======================================================================================

Answer
------

SETP receiver: SETP operation raised an unknown exception. The product recorded this while processing setp receiver; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`SETP receiver: SETP operation raised an unknown exception. Additional detail: {event_detail}`
...
Repeat or monitor the affected operation and confirm that Event ID 11094 does not recur and that setp receiver processing continues.
...
- :ref:`Event ID 11090 <eventreporter-event-id-11090>`
- :ref:`Event ID 11091 <eventreporter-event-id-11091>`
- :ref:`Event ID 11092 <eventreporter-event-id-11092>`
