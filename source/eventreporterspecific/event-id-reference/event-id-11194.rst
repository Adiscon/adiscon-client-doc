...
.. _eventreporter-event-id-11194:

.. meta::
   :description: Meaning and troubleshooting for EventReporter Event ID 11194: Product runtime: message compression failed.
   :event-id: 11194
...
EventReporter Event ID 11194: Product runtime: message compression failed
=========================================================================

Answer
------

Product runtime: message compression failed. The product recorded this while processing product runtime; the appended event detail identifies the affected object, operation, or provider error.
...
- **Message pattern:** :spelling:ignore:`Csyslogclient send udp. Additional detail: {event_detail}`
...
- :ref:`Event ID 11169 <eventreporter-event-id-11169>`
