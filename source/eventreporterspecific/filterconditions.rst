...
every 60 seconds, even if all other conditions are true. **Note:** If you want to know more about :doc:`complex filter conditions <../shared/references/complexfilterconditions>` you can click on
the "Learn about Filters" link.
